class CreateProjectScores90Table < ActiveRecord::Migration
  tag :predeploy
  def change
    # NOTE: updated to match Spring 2020. Added Mock Interview Feedback and re-ordered things relative to Fall 2019
    # There is 1 extra column from RUN, the LYL Final Exam.
    orig_column_names = [
       'Student ID',
       'Student Name',
       'Student Email',
       ...
       'Total Score -- Live Your Legacy Final Exam',
    ...
    create_table :course90_project_scores do |t|
