class AddCourse81ProjectScores < ActiveRecord::Migration
  tag :predeploy
  def change
    ...
    orig_column_names = [
      ...
      '1.3 Action plan includes all parts of BravenX projects and appropriate start and due dates. -- Design Your Career Project',
      '1.4 Action plan includes all BravenX To Dos and appropriate start and due dates. -- Design Your Career Project',
      ...
      '3.7 Creates milestones that will help participant stay on track towards big goals. -- Design Your Career Project',
      ...
      '1.15 Conducts one informational interview. -- Hustle to Career Project',
      ...
      '2.11 Includes BravenX or other leadership experience on resume. -- Hustle to Career Project',
      ...
      '2.8 Experiences included are relevant and demonstrate commitment. -- Hustle to Career Project',
    ...
    create_table :course81_project_scores do |t|
