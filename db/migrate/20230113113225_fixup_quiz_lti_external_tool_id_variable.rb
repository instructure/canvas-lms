...
class FixupQuizLtiExternalToolIdVariable < ActiveRecord::Migration[6.1]
  tag :postdeploy

  def up
    DataFixup::AddExternalToolIdToQuizLtiTools.delay_if_production(priority: Delayed::LOW_PRIORITY).run
  end
end
