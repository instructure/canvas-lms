...
class AddMigrateFromToAssignments < ActiveRecord::Migration[5.2]
  tag :predeploy
  disable_ddl_transaction!

  def change
    add_reference :assignments, :migrate_from, type: :bigint, foreign_key: { to_table: :quizzes }, index: false
  end
end
