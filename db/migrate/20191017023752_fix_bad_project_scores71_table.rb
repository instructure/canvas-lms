class FixBadProjectScores71Table < ActiveRecord::Migration
  tag :predeploy
  def change
    ...
    orig_column_names = [
       ...
       'Total Score -- Hustle to Career 2.0',
       'Category 1 Average -- Hustle to Career 2.0',
       '1.1 Fellow submitted applications to three career-accelerating opportunities. -- Hustle to Career 2.0',
       '1.2 Fellow indicates response received from employer/fellowship/grad school. -- Hustle to Career 2.0',
       '1.3 Fellow plans out appropriate next steps for each opportunity. -- Hustle to Career 2.0',
       '1.4 Fellow operates with a growth mindset when applying to opportunities. -- Hustle to Career 2.0',
       '1.5 Fellow determines how to apply to opportunities more efficiently. -- Hustle to Career 2.0',
    ...
    # The old version of this table doesn't need the data to persist since it just holds a dump of the 
    # current detailed rubric level score breakdown so that we can pull the data in elsewhere (aka Periscope).
    # Rather than try to write add/remove column stuff, just drop and recreate.
    drop_table :course71_project_scores
