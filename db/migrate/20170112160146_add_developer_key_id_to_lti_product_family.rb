...
class AddDeveloperKeyIdToLtiProductFamily < ActiveRecord::Migration[4.2]
  ...
  def change
    ...
    remove_index :lti_product_families, column: %i[root_account_id vendor_code product_code], name: "index_lti_product_families_on_root_account_vend_code_prod_code", unique: true
