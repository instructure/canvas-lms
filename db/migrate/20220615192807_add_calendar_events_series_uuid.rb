...
class AddCalendarEventsSeriesUuid < ActiveRecord::Migration[6.1]
  disable_ddl_transaction!
  tag :predeploy

  def change
    add_column :calendar_events, :series_uuid, :uuid, if_not_exists: true
    add_index :calendar_events, :series_uuid, algorithm: :concurrently, if_not_exists: true
  end
end
