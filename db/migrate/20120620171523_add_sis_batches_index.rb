class AddSisBatchesIndex < ActiveRecord::Migration
  ...
  def self.up
    ...
    when 'PostgreSQL'
      ...
      add_index :sis_batches, [:account_id, :created_at], :concurrently => true, :conditions => "workflow_state='created'"
    ...
    add_index :sis_batches, [:account_id, :created_at], :concurrently => true, :name => "index_sis_batches_account_id_created_at"
  end
