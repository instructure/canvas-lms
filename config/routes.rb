...
CanvasRails::Application.routes.draw do
  ...
  get 'confirmations/:user_id/re_send(/:id)' => 'communication_channels#re_send_confirmation', as: :re_send_confirmation, id: nil
  ...
  get 'saml_consume' => 'pseudonym_sessions#saml_consume'
  ...
  ApiRouteSet.draw(self, "/api/lti/v1") do
    ...
    post "tools/:tool_id/xapi", controller: :lti_api, action: :xapi, as: "lti_xapi"
  end
