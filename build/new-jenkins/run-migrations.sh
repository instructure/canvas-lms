...
CASSANDRA_LOAD_TAG="$CASSANDRA_PREFIX:${CACHE_LOAD_SCOPE}-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"
DYNAMODB_LOAD_TAG="$DYNAMODB_PREFIX:${CACHE_LOAD_SCOPE}-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"
POSTGRES_LOAD_TAG="$POSTGRES_PREFIX:${CACHE_LOAD_SCOPE}-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"

CASSANDRA_SAVE_TAG="$CASSANDRA_PREFIX:$CACHE_SAVE_SCOPE-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"
DYNAMODB_SAVE_TAG="$DYNAMODB_PREFIX:$CACHE_SAVE_SCOPE-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"
POSTGRES_SAVE_TAG="$POSTGRES_PREFIX:$CACHE_SAVE_SCOPE-$MIGRATIONS_CACHE_MD5-$TAG_THREADS_SUFFIX"
