...
var Header = React.createClass({
        ...
        <div className="ic-notification">
          ...
          <div className="ic-notification__content">
            <div className="ic-notification__message">
              <div className="ic-notification__title">{I18n.t('Attention!')}</div>
  ...
  renderPostButton() {
    return (
      this.props.permissions.editGrades && (
        <button
          ref={p => {
            this.publishBtn = p
          }}
        ...
        <div className="ModeratedGrading__Header ic-Action-header">
          ...
          <div className="ic-Action-header__Secondary ModeratedGrading__Header-Buttons ">
            <button
              ...
              disabled={
                this.props.published || this.noStudentSelected() || this.props.inflightAction.review
              }
            >
              <span className="screenreader-only">
                {I18n.t('Add a reviewer for the selected students')}
              </span>
