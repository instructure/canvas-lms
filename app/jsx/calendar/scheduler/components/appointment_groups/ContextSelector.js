  ...
  renderSections(context) {
    return (
      <div
        ...
        className={this.state.expandedContexts.has(context) ? '' : 'hiddenSection'}
      >
        {(context.sections || []).map(section => {
          return (
            <div className="sectionItem" key={section.asset_string}>
              ...
              />
              <label className="ContextLabel" htmlFor={`${section.asset_string}_checkbox`}>
                {section.name}
              </label>
            </div>
          )
        ...
        {this.props.contexts.map(context => {
          ...
          return (
            <div className="CourseListItem" key={context.asset_string}>
              ...
              />
              <label className="ContextLabel" htmlFor={inputId}>
                {context.name}
              </label>
        ...
        >
          <Grid>
            <GridRow hAlign="start">
              <GridCol>{this.renderListItems()}</GridCol>
            </GridRow>
            <GridRow hAlign="end">
              <GridCol width="auto">
