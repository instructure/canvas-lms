...
var DueDateRow = React.createClass({
  ...
  tokenizedOverrides() {
    var {sectionOverrides, groupOverrides, adhocOverrides, noopOverrides} = _.groupBy(
  ...
  nameForGroup(groupId) {
    return this.nameOrLoading(this.props.groups, groupId)
  },

  nameForStudentToken(studentId) {
    return this.nameOrLoading(this.props.students, studentId)
  },
