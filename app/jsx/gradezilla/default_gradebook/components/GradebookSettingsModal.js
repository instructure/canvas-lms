...
class GradebookSettingsModal extends React.Component {
  ...
  fetchLatePolicy = () => {
    GradebookSettingsModalApi.fetchLatePolicy(this.props.courseId)
      .then(this.onFetchLatePolicySuccess)
      .catch(this.onFetchLatePolicyFailure)
  }

  createLatePolicy = () => {
    GradebookSettingsModalApi.createLatePolicy(this.props.courseId, this.state.latePolicy.changes)
      .then(this.onUpdateLatePolicySuccess)
      .catch(this.onUpdateLatePolicyFailure)
  }

  updateLatePolicy = () => {
    GradebookSettingsModalApi.updateLatePolicy(this.props.courseId, this.state.latePolicy.changes)
      .then(this.onUpdateLatePolicySuccess)
      .catch(this.onUpdateLatePolicyFailure)
  }
