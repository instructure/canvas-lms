...
class LatePoliciesTabPanel extends React.Component {
  ...
  constructor(props) {
    ...
    this.changeMissingSubmissionDeduction = this.validateAndChangeNumber.bind(
      this,
      'missingSubmissionDeduction'
    )
    this.changeLateSubmissionDeduction = this.validateAndChangeNumber.bind(
      this,
      'lateSubmissionDeduction'
    )
    this.changeLateSubmissionMinimumPercent = this.validateAndChangeNumber.bind(
      this,
      'lateSubmissionMinimumPercent'
    )
    this.missingPolicyMessages = messages.bind(this, ['missingSubmissionDeduction'])
    this.latePolicyMessages = messages.bind(this, [
      'lateSubmissionDeduction',
      'lateSubmissionMinimumPercent'
    ])
  }
            ...
            <div style={{marginLeft: '0.25rem'}}>
                ...
                <Container as="div" margin="0 0 x-small 0">
                  <label htmlFor="missing-submission-grade">
                    <Text size="small" weight="bold">
                      {I18n.t('Missing submission grade')}
                    </Text>
                  </label>
                </Container>
              </PresentationContent>
              ...
              <div className="NumberInput__Container">
                <NumberInput
                  ...
                  label={
                    <ScreenReaderContent>
                      {I18n.t('Missing submission grade percent')}
                    </ScreenReaderContent>
                  }
            ...
            <div style={{marginLeft: '0.25rem'}}>
              <Container display="inline" as="div" margin="0 small 0 0">
                ...
                <div style={{display: 'flex', alignItems: 'center'}}>
                  <NumberInput
                    ...
                    label={
                      <ScreenReaderContent>
                        {I18n.t('Late submission deduction percent')}
                      </ScreenReaderContent>
                    }
              ...
              <Container display="inline" as="div" margin="0 0 0 small">
                ...
                <Select
                  ...
                  label={
                    <ScreenReaderContent>
                      {I18n.t('Late submission deduction interval')}
                    </ScreenReaderContent>
                  }
                  inline
                  width="6rem"
            ...
            <div style={{marginLeft: '0.25rem'}}>
              ...
              <div style={{display: 'flex', alignItems: 'center'}}>
                <NumberInput
                  ...
                  label={
                    <ScreenReaderContent>
                      {I18n.t('Lowest possible grade percent')}
                    </ScreenReaderContent>
                  }
