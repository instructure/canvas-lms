...
class Collaboration extends React.Component {
  ...
  render() {
    ...
    let [context, contextId] = splitAssetString(ENV.context_asset_string)
    let editUrl = `/${context}/${contextId}/lti_collaborations/external_tools/retrieve?content_item_id=${
      collaboration.id
    }&placement=collaboration&url=${collaboration.update_url}&display=borderless`
