      ...
      <div className="al-dropdown__container create-collaborations-dropdown">
        {hasOne ? (
          <a
            ...
            href={`/${context}/${contextId}/lti_collaborations/external_tools/${
              this.props.ltiCollaborators[0].id
            }?launch_type=collaboration&display=borderless`}
          >
          ...
          <div>
            ...
            >
              {this.props.ltiCollaborators.map(ltiCollaborator => {
                let itemUrl = `lti_collaborations/external_tools/${
                  ltiCollaborator.id
                }?launch_type=collaboration&display=borderless`
                return (
