...
var Group = React.createClass({
  ...
  render() {
    ...
    var groupName = I18n.t('%{group_name} in %{group_category_name} group category', {
    ...
    var arrow = (
      <i
        ...
        aria-label={
          arrowDown
            ? I18n.t('Collapse list of group members for %{groupName}', {groupName: groupName})
      ...
      <div id={studentGroupId} className={`student-group-body${showBody ? '' : ' hidden'}`}>
        ...
        >
          {this.props.group.users.map(u => {
            ...
            var leaderBadge = isLeader ? <i className="icon-user" aria-hidden="true" /> : null
            return (
