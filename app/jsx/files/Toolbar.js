...
Toolbar.render = function() {
  ...
  return (
    <header className="ef-header" role="region" aria-label={I18n.t('Files Toolbar')}>
      <form className={formClassName} onSubmit={this.onSubmitSearch}>
        <input
      ...
      <div className="ef-header__secondary">
        <div className={buttonSetClasses}>
          <a
            ...
            title={
              selectedItemIsFolder ? I18n.t('Viewing folders is not available') : I18n.t('View')
            }
            role="button"
            aria-label={
              selectedItemIsFolder ? I18n.t('Viewing folders is not available') : I18n.t('View')
