...
UsageRightsDialog.renderFolderTooltip = function(folders) {
  ...
  if (toolTipFolders.length) {
    var displayNames = toolTipFolders.map(item => {
      return htmlEscape(item.displayName()).toString()
    })
    ...
    return (
      <div>
        ...
        <div className="form-horizontal">
          ...
          <RestrictedRadioButtons ref="restrictedSelection" models={this.props.itemsToManage} />
        </div>
      </div>
    )
  }
    ...
    <div className="ReactModal__Layout">
      <div className="ReactModal__Header">
        <div className="ReactModal__Header-Title">
          <h4>{I18n.t('Manage Usage Rights')}</h4>
        </div>
      ...
      <div className="ReactModal__Footer">
        <div className="ReactModal__Footer-Actions">
          <button ref="cancelButton" type="button" className="btn" onClick={this.props.closeModal}>
            {I18n.t('Cancel')}
          </button>
          <button ref="saveButton" type="button" className="btn btn-primary" onClick={this.submit}>
            {I18n.t('Save')}
          </button>
        </div>
      </div>
