...
FilesApp.render = function() {
  ...
  var userCanManageFilesForContext = filesEnv.userHasPermission(
  ...
  var usageRightsRequiredForContext = filesEnv.contextsDictionary[`${contextType}_${contextId}`]
    ...
    : false
  var externalToolsForContext = filesEnv.contextFor({
  ...
  return (
    <div>
      ...
      <div className="ef-main">
        {filesEnv.newFolderTree && <p>New folder tree goes here</p>}
