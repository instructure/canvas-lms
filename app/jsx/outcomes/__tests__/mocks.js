...
export const findOutcomeGroupMockData = {
  id: '0',
  title: 'State Standards',
  description: '<p>State Standards description.',
  children: [
    {
      id: '1',
      title: 'CCSS.Math.Content.2.MD.A.1',
      description: '<p>Measure the length of an object by selecting and using appropriate tools. <p>'.repeat(
        3
      )
    },
    {
      ...
      description: '<p>Measure the length of an object twice, using length units of different lengths for the two measurements. </p>'.repeat(
        2
      )
    },
    {
      id: '3',
      title: 'CSSS.Math.Content.2.MD.A.3',
      description: '<p>Estimate lengths using units of inches, feet, centimeters, and meters. </p>'.repeat(
        3
      )
    },
    {
      id: '4',
      title: 'CCSS.Math.Content.2.MD.A.4.Example.of.Outcome.without.Description',
      description: ''
    },
    {
      id: '5',
      title: 'CCSS.Math.Content.2.MD.A.5',
      description: '<p>Measure to determine how much longer one object is than another. <p>'.repeat(
        2
      )
    },
    {
      id: '6',
      title: 'CCSS.Math.Content.2.MD.A.6',
      description: '<p>Measure the length of an object by selecting and using appropriate tools. <p>'.repeat(
        3
      )
    },
