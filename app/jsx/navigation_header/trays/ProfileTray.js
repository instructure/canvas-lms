  ...
  render() {
    return (
      <div className="profile-tray">
        <div
          className="ic-NavMenu__header ic-NavMenu__header--is-profile"
          id="global_nav_profile_header"
        >
        ...
        <ul className="ic-NavMenu__link-list">
          {this.props.profileEnabled && (
            <li className="ic-NavMenu-list-item">
              <a href="/profile" className="ic-NavMenu-list-item__link">
                {I18n.t('Profile')}
              </a>
            </li>
          )}
          <li className="ic-NavMenu-list-item">
            <a href="/profile/settings" className="ic-NavMenu-list-item__link">
              {I18n.t('Settings')}
            </a>
          </li>
          <li className="ic-NavMenu-list-item">
            <a href="/profile/communication" className="ic-NavMenu-list-item__link">
              {I18n.t('Notifications')}
            </a>
          </li>
          <li className="ic-NavMenu-list-item">
            <a href="/files" className="ic-NavMenu-list-item__link">
              {I18n.t('Files')}
            </a>
          </li>
          {this.props.eportfoliosEnabled && (
            <li className="ic-NavMenu-list-item">
              <a href="/dashboard/eportfolios" className="ic-NavMenu-list-item__link">
                {I18n.t('ePortfolios')}
              </a>
            </li>
          )}
