  ...
  renderCourses() {
    ...
    var courses = this.props.courses.map(course => {
      return (
        <li key={course.id} className="ic-NavMenu-list-item">
          <a href={`/courses/${course.id}`} className="ic-NavMenu-list-item__link">
            {course.name}
          </a>
          {course.enrollment_term_id > 1 ? (
            <div className="ic-NavMenu-list-item__helper-text">{course.term.name}</div>
          ) : null}
        </li>
      )
    })
    courses.push(
      <li key="allCourseLink" className="ic-NavMenu-list-item ic-NavMenu-list-item--feature-item">
        <a href="/courses" className="ic-NavMenu-list-item__link">
          {I18n.t('All Courses')}
        </a>
      </li>
    )
    ...
    return (
      <div className="ic-NavMenu__layout">
        <div className="ic-NavMenu__primary-content">
          ...
          <ul className="ic-NavMenu__link-list">{this.renderCourses()}</ul>
        </div>
