...
function PointsDisplayGradingScheme({receivedGrade}) {
...
PointsDisplayGradingScheme.propTypes = {
  receivedGrade: PropTypes.oneOf([PropTypes.number, PropTypes.string])
}

PointsDisplayGradingScheme.defaultProps = {}

export default React.memo(PointsDisplayGradingScheme)
