...
export default function MasqueradePanda () {
  return (
    <svg
      viewBox="0 0 129 157"
      className="MasqueradeModal__panda"
    >
      <path
        className="MasqueradeModal__panda-1"
        d="M125.68 154.71a61.07 61.07 0 0 0-122.11 0z"
      />
      <circle
        className="MasqueradeModal__panda-2"
        cx="104.62"
        cy="24.31"
        r="21.09"
      />
      <circle
        className="MasqueradeModal__panda-3"
        cx="104.62"
        cy="24.31"
        r="12"
      />
      ...
      <path
        className="MasqueradeModal__panda-4"
        d="M59.39 76.92h10.47"
      />
      <path
        className="MasqueradeModal__panda-5"
      ...
      />
      <path
        className="MasqueradeModal__panda-6"
      ...
      />
      <circle
        className="MasqueradeModal__panda-7"
        cx="89.58"
        cy="52.93"
        r="2.62"
      />
