...
class OutcomeGroupsApiController < ApplicationController
  ...
  def update
    ...
    @outcome_group.update_attributes(strong_params.permit(:title, :description, :vendor_guid))
  ...
  def link
    ...
    if params[:outcome_id]
      ...
      outcome_params = strong_params.permit(:title, :description, :mastery_points, :vendor_guid,
  ...
  def create
    ...
    @outcome_group = context_outcome_groups.find(params[:id])
    @child_outcome_group = @outcome_group.child_outcome_groups.build(strong_params.permit(:title, :description, :vendor_guid))
