...
class MediaTracksController < ApplicationController
  ...
  #
  # @example_request
  #     curl https://<canvas>/api/v1/media_objects/<media_object_id>/media_tracks \ 
  #         -F kind='subtitles' \ 
  #         -F locale='es' \ 
  ...
  # @API Get the content of a Media Track
  #
  # returns the actual content of the uploaded media track.
  #
  # @example_request
  #     curl https://<canvas>/api/v1/media_objects/<media_object_id>/media_tracks/<media_track_id> \ 
  #          -H 'Authorization: Bearer <token>'
  #
  def show
  ...
  #
  # @example_request
  #     curl -X DELETE https://<canvas>/api/v1/media_objects/<media_object_id>/media_tracks/<media_track_id> \ 
  #          -H 'Authorization: Bearer <token>'
  #
  # @returns Media Object
  def destroy
