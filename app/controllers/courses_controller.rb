...
class CoursesController < ApplicationController
  ...
  #
  # @argument include[] [String, "needs_grading_count"|"syllabus_body"|"public_description"|"total_scores"|"current_grading_period_scores"|"term"|"account_name"|"course_progress"|"sections"|"storage_quota_used_mb"|"total_students"|"passback_status"|"favorites"|"teachers"|"observed_users"|"course_image"]
  ...
  #     is returned.
  #   - "account_name": Optional information to include with each Course. When
  #     account_name is given, the account_name for each course is returned.
  ...
  #
  # @argument include[] [String, "needs_grading_count"|"syllabus_body"|"public_description"|"total_scores"|"current_grading_period_scores"|"term"|"account_name"|"course_progress"|"sections"|"storage_quota_used_mb"|"total_students"|"passback_status"|"favorites"|"teachers"|"observed_users"|"all_courses"|"permissions"|"observed_users"|"course_image"]
  ...
  def courses_for_user(user, paginate_url: api_v1_courses_url)
    ...
    preloads << :account if includes.include?('subaccount') || includes.include?('account_name')
