  ...
  def self.preload_participants(conversations)
    ...
    Shard.with_each_shard(shards) do
      ...
      user_map = Shackles.activate(shackles_env) do
        User.select("users.id, users.updated_at, users.short_name, users.name, users.avatar_image_url, users.account_pronoun_id, users.avatar_image_source, last_authored_at, conversation_id").
