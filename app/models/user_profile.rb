...
class UserProfile
  ...
  def tabs_available(user=nil, opts={})
    @tabs ||= [
      ...
      { :id => TAB_PROFILE, :label => I18n.t('tabs.profile', "Profile"), :css_class => 'profile', :href => :profile_path, :no_args => true },
      { :id => TAB_COMMUNICATION_PREFERENCES, :label => I18n.t('tabs.notifications', "Notifications"), :css_class => 'notifications', :href => :communication_profile_path, :no_args => true },
