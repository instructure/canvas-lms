...
require [
  ...
  @calendar = new Calendar("#calendar-app", ENV.CALENDAR.CONTEXTS, ENV.CALENDAR.MANAGE_CONTEXTS, @eventDataSource, activateEvent: ENV.CALENDAR.ACTIVE_EVENT, viewStart: ENV.CALENDAR.VIEW_START)
