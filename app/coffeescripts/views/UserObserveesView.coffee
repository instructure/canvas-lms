...
define [
...
], ($, _, I18n, template, pairingCodeTemplate, extAuthTemplate, itemView, PaginatedCollectionView) ->
  ...
  class UserObserveesView extends PaginatedCollectionView
    ...
    addObservee: (ev) ->
      ...
      data = if ENV.USE_PAIRING_CODE then data else  {observee: data}
