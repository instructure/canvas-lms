...
import template from 'jst/calendar/agendaView'
import '../../calendar/fcMomentHandlebarsHelpers' # make sure fcMomentToString is available to agendaView.handlebars
