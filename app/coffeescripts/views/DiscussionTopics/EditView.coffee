...
import AssignmentGroupSelector from '../assignments/AssignmentGroupSelector'
import GradingTypeSelector from '../assignments/GradingTypeSelector'
import GroupCategorySelector from '../assignments/GroupCategorySelector'
import PeerReviewsSelector from '../assignments/PeerReviewsSelector'
import PostToSisSelector from '../assignments/PostToSisSelector'
import _ from 'underscore'
import React from 'react'
import ReactDOM from 'react-dom'
import template from 'jst/DiscussionTopics/EditView'
...
import flashMessage from '../../jquery.rails_flash_notifications'
