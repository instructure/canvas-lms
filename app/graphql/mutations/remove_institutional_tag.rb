...
# NOTE: Depends on InstitutionalTagAssociation model

module Mutations
  class RemoveInstitutionalTag < BaseMutation
    argument :tag_id,
             ID,
             required: true,
    ...
    def resolve(input:) # rubocop:disable GraphQL/UnusedArgument
      ...
      raise GraphQL::ExecutionError, "not found" unless assoc

      assoc.workflow_state = "deleted"
