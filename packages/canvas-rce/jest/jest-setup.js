...
const ignoredErrors = [
  ...
  /The prop `editor` is marked as required in `IconMakerTray`/,
  ...
  /The prop `onImageClick` is marked as required in `ImageList`/,
  ...
  /The prop `editor` is marked as required in `ImageSection`/,
  ...
  /The prop `onLinkClick` is marked as required in `LinkSet`/,
