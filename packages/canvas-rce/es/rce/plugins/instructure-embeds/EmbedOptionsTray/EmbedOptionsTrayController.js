...
import { getContentFromEditor } from "../../shared/ContentSelection.js";
import EmbedOptionsTray from "./index.js";
...
export default class EmbedOptionsTrayController {
  ...
  _renderTray() {
    ...
    const element = /*#__PURE__*/React.createElement(EmbedOptionsTray, {
      content: content,
      key: this._renderId,
      onEntered: () => {
        this._isOpen = true;
