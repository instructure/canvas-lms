...
const RceHtmlEditor = /*#__PURE__*/React.forwardRef((_ref, editorRef) => {
  let onFocus = _ref.onFocus,
      props = _objectWithoutProperties(_ref, _excluded);

  const _useState = useState(props.code),
  ...
  const _useState3 = useState(getComputedStyle(document.body, null).direction),
