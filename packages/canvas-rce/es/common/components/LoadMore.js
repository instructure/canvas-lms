...
class LoadMore extends Component {
  constructor(props) {
    ...
    this.loadMore = ev => {
      this.setState({
        nextFocus: this.focusableElements().length
      });
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ref: "parent"
    }, this.props.children, this.props.hasMore && !this.props.isLoading && /*#__PURE__*/React.createElement("div", {
      className: css(styles.button)
    }, /*#__PURE__*/React.createElement(Button, {
      variant: "link",
      onClick: this.loadMore,
      fluidWidth: true
    }, formatMessage('Load more results'))), hasChildren && this.props.hasMore && /*#__PURE__*/React.createElement("div", {
...
LoadMore.propTypes = {
  ...
  /* Immutable.List is not a valid 'node' */
