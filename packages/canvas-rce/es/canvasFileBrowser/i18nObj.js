...
import htmlEscape from "./htmlEscape.js"; // add i18nliner's runtime extensions to the global I18n object
...
I18n.interpolate = function (message, origOptions) {
  const options = _objectSpread({}, origOptions);
...
I18n.n = I18n.localizeNumber = (value, options = {}) => {
  const format = _objectSpread(_objectSpread({}, I18n.lookup('number.format') || {}), {}, {
