...
describe('buildMetadata() / parseMetadata()', () => {
  it('builds metadata element and parse it back', () => {
    ...
    expect(metadata).toMatchInlineSnapshot(`
      <metadata>
        {"type":"image/svg+xml-buttons-and-icons","name":"","alt":"","shape":"triangle","size":"small","color":"#f0f","outlineColor":null,"outlineSize":"none","text":"","textSize":"small","textColor":"#000000","textBackgroundColor":null,"textPosition":"middle","encodedImage":"","encodedImageType":"","encodedImageName":"","x":0,"y":0,"translateX":0,"translateY":0,"width":0,"height":0,"transform":""}
      </metadata>
    `)
