...
describe('buildMetadata() / parseMetadata()', () => {
  it('builds metadata element and parse it back', () => {
    ...
    expect(metadata).toMatchInlineSnapshot(`
      <metadata>
        {"name":"","alt":"","shape":"triangle","size":"small","color":"#f0f","outlineColor":null,"outlineSize":"none","text":"","textSize":"small","textColor":null,"textBackgroundColor":null,"textPosition":"middle","encodedImage":"","encodedImageType":"","encodedImageName":""}
      </metadata>
    `)
