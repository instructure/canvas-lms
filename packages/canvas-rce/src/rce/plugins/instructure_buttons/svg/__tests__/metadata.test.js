...
describe('buildMetadata() / parseMetadata()', () => {
  it('builds metadata element and parse it back', () => {
    ...
    expect(metadata).toMatchInlineSnapshot(`
      <metadata>
        {"type":"image/svg+xml-buttons-and-icons","name":"","alt":"","shape":"triangle","size":"small","color":"#f0f","outlineColor":null,"outlineSize":"none","text":"","textSize":"small","textColor":null,"textBackgroundColor":null,"textPosition":"middle","encodedImage":"","encodedImageType":"","encodedImageName":""}
      </metadata>
    `)
