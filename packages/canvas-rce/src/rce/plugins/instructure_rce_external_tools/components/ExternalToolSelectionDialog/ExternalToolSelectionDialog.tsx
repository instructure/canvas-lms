...
export function filterItemsByTitleSubstring<T extends { title: string }>(
	...
	return items.filter((item) =>
		item.title.toLocaleLowerCase().includes(lowerTerm),
	);
}
...
export function ExternalToolSelectionDialog(
	props: ExternalToolSelectionDialogProps,
): JSX.Element {
	...
	const handleFilterChange = (e: ChangeEvent<HTMLInputElement>) => {
		...
		setFilteredResults(
			filterItemsByTitleSubstring(e.target.value, props.ltiButtons),
		);
	};
