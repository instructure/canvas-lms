tinymce.addI18n('sv_SE', {
  ...
  'To open the popup, press Shift+Enter':
    'Tryck p\u00e5 Shift\u00a0+\u00a0Enter f\u00f6r att \u00f6ppna popup-f\u00f6nstret',
  'Rich Text Area. Press ALT-0 for help.':
    'Omr\u00e5de med formaterad text. Tryck p\u00e5 ALT-0 f\u00f6r hj\u00e4lp.',
  'System Font': 'Systemtypsnitt',
  'Failed to upload image: {0}': 'Kunde inte ladda upp bild: {0}',
  'Failed to load plugin: {0} from url {1}':
    'Kunde inte l\u00e4sa in insticksprogram: {0} fr\u00e5n webbadress {1}',
  'Failed to load plugin url: {0}':
    'Kunde inte l\u00e4sa in webbadress f\u00f6r insticksprogram: {0}',
  ...
  'Error: Form submit field collision.':
    'Fel: Kollision f\u00e4lt f\u00f6r s\u00e4ndning av formul\u00e4r.',
