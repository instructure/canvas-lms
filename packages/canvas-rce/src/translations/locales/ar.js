...
const locale = {
  ...
  "ai_response_9624e8e8": { "message": "استجابة الذكاء الاصطناعي" },
  "ai_tools_fda01177": { "message": "أدوات الذكاء الاصطناعي" },
  ...
  "compose_44c904f4": { "message": "إنشاء" },
  ...
  "content_in_the_editor_will_be_changed_press_cancel_d5bf3357": {
    "message": "سيتغير المحتوى في المحرر. اضغط على إلغاء للاحتفاظ بالمحتوى الأصلي."
  },
  ...
  "dislike_14befc48": { "message": "عدم إعجاب" },
  ...
  "enter_text_8b35c65b": { "message": "أدخل نصًا" },
  ...
  "failed_to_copy_response_d3def551": { "message": "تعذر نسخ الاستجابة" },
  ...
  "hello_please_describe_the_modifications_you_would__49b19837": {
    "message": "مرحبًا. يرجى وصف التعديلات التي ترغب في إجرائها للإنشاء."
  },
  "hello_please_describe_the_modifications_you_would__600dbbf0": {
    "message": "مرحبًا. يرجى وصف التعديلات التي ترغب في إجرائها للتحديد."
  },
  ...
  "i_m_sorry_but_i_cannot_find_the_ai_s_answer_67569d19": {
    "message": "عذرًا، لا يمكنني العثور على إجابة الذكاء الاصطناعي"
  },
  ...
  "if_left_empty_link_text_will_display_as_course_lin_2a34eedb": {
    "message": "إذا ترك الارتباط فارغًا، سيُعرض النص كاسم ارتباط مساق"
  },
  ...
  "response_copied_to_clipboard_130d66cd": {
    "message": "تم نسخ الاستجابة إلى الحافظة"
  },
  "restore_auto_save_deccd84b": { "message": "استعادة الحفظ التلقائي؟" },
  "result_index_of_max_7db5ad8b": { "message": "نتيجة { index } من { max }." },
  "retry_ebd5f8ba": { "message": "إعادة المحاولة" },
  ...
  "show_all_967a90f0": { "message": "إظهار الكل" },
  ...
  "waiting_for_response_1efd0c50": { "message": "بانتظار الاستجابة" },
  ...
  "what_would_you_like_to_do_6dc0d541": { "message": "ما الذي ترغب في فعله؟" },
