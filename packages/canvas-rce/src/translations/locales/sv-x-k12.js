...
const locale = {
  ...
  "align_center_ca078feb": { "message": "Centrera" },
  "align_left_e9f1f93b": { "message": "Vänsterjustera" },
  "align_right_9bad3ac1": { "message": "Högerjustera" },
  "alignment_and_indentation_f7de34bf": { "message": "Justering och indrag" },
  ...
  "an_error_occurred_generating_the_file_preview_cf259955": {
    "message": "Ett fel uppstod vid generering av förhandsvisning av filen."
  },
  ...
  "audio_and_video_recording_is_not_available_c7173efc": {
    "message": "Ljud- och videoinspelning är inte tillgänglig."
  },
  ...
  "click_any_page_to_insert_a_link_to_that_page_ac920c02": {
    "message": "Klicka på en sida för att infoga en länk till sidan."
  },
  ...
  "directionality_ebcae6d0": { "message": "Riktning" },
  ...
  "embed_options_tray_901cfd19": { "message": "Bädda in alternativfält" },
  "embed_preview_2d741e1f": { "message": "Bädda in förhandsvisning" },
  "embed_video_a97a64af": { "message": "Bädda in videon" },
  "embed_video_code_703e10f2": { "message": "Bädda in videokod" },
  ...
  "error_uploading_video_audio_recording_16d9730a": {
    "message": "Ett fel uppstod vid uppladdning av video-/ljudinspelningen"
  },
  "expand_to_see_types_f5d29352": {
    "message": "Expandera för att visa { types }"
  },
  "external_links_3d9f074e": { "message": "Externa länkar" },
  ...
  "focus_the_popup_context_toolbar_7979f4f8": {
    "message": "Fokusera verktygsfältets popupinnehåll"
  },
  ...
  "left_to_right_d6da6d7e": { "message": "vänster till höger" },
  ...
  "load_more_results_460f49a9": { "message": "Läs in fler resultat" },
  ...
  "loading_media_f3455841": { "message": "Läser in media" },
  "locked_762f138b": { "message": "Låst" },
  "media_af190855": { "message": "Media" },
  "medium_5a8e9ead": { "message": "Medium" },
  "mic_a7f3d311": { "message": "Mikrofon" },
  "miscellaneous_and_apps_f450a387": { "message": "Övrigt och appar" },
  ...
  "no_alt_text_decorative_image_f318fc0e": {
    "message": "Ingen alternativtext (dekorativ bild)"
  },
  ...
  "preformatted_d0670862": { "message": "Förformaterade" },
  "preview_53003fd2": { "message": "Förhandsgranska" },
  "preview_a3f8f854": { "message": "FÖRHANDSVISA" },
  "previous_page_928fc112": { "message": "Föregående sida" },
  ...
  "reading_a_media_track_file_failed_aborting_be051b20": {
    "message": "Det gick inte att läsa en mediespårsfil. Avbryter."
  },
  ...
  "something_went_wrong_accessing_your_mic_or_webcam_6e3cad12": {
    "message": "Något gick fel vid försök att komma åt din mikrofon eller webbkamera."
  },
  ...
  "submit_a3cc6859": { "message": "Skicka in" },
  ...
  "switch_to_raw_html_editor_4c9ac7de": {
    "message": "Växla till rå HTML-redigerare"
  },
  "switch_to_rich_text_editor_35822d26": {
    "message": "Växla till RTF-redigerare"
  },
  ...
  "video_audio_recording_uploaded_6af5d378": {
    "message": "Video/ljudinspelning har laddats upp"
  },
