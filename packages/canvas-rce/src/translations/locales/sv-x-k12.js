...
const locale = {
  ...
  "background_1bc88842": { "message": "Bakgrund" },
  ...
  "color_a363e1b0": { "message": "Färg" },
  "color_contrast_4c418add": { "message": "Färgkontrast" },
  "color_contrast_ratio_687782f0": { "message": "Färgkontrastförhållande" },
  "color_picker_6b359edf": { "message": "Färgväljaren" },
  "color_picker_colorname_selected_ad4cf400": {
    "message": "Färgväljaren ({ colorName } valda)"
  },
  "color_popup_af39810f": { "message": "Färg-popup" },
  ...
  "custom_width_and_height_pixels_946eea7c": {
    "message": "Anpassad bredd och höjd (pixlar)"
  },
  ...
  "fail_544e5dde": { "message": "MISSLYCKADES" },
  ...
  "find_8d605019": { "message": "Hitta" },
  "find_and_replace_6e345933": { "message": "Sök och ersätt" },
  ...
  "graphics_text_bc9568bc": { "message": "Bildtext" },
  ...
  "input_field_for_alpha_678265fd": { "message": "Inmatningsfält för alfa" },
  "input_field_for_blue_561e020a": { "message": "Inmatningsfält för blått" },
  "input_field_for_green_67f8b2b6": { "message": "Inmatningsfält för grönt" },
  "input_field_for_red_86a84615": { "message": "Inmatningsfält för rött" },
  ...
  "large_text_e7ba08cd": { "message": "Stor text" },
  ...
  "no_results_found_58717065": { "message": "Inga resultat hittades" },
  ...
  "one_or_more_files_failed_to_paste_please_try_uploa_7fa39dd3": {
    "message": "En eller fler filer klistrades inte in. Försök ladda upp eller dra och släpp filer."
  },
  ...
  "percentage_must_be_at_least_percentage_a98ca8fc": {
    "message": "Procenttalet måste vara minst { percentage }%"
  },
  ...
  "previously_chosen_colors_f1338315": { "message": "Tidigare valda färger" },
  ...
  "you_are_on_a_color_palette_to_navigate_on_the_pale_227fc3a6": {
    "message": "Du är på en färgpalett. För att navigera upp, till vänster/höger eller ned på paletten, använd knapparna W, A, S och D."
  },
  "you_are_on_a_color_slider_to_navigate_the_slider_l_e800f68a": {
    "message": "Du är på ett färgreglage. För att navigera upp, till vänster/höger eller ned i skjutreglaget, använd knapparna A och D."
  },
  "you_are_on_an_alpha_slider_to_navigate_the_slider__3a014dc5": {
    "message": "Du är på ett alfareglage. För att navigera upp, till vänster/höger eller ned i skjutreglaget, använd knapparna A och D."
  },
