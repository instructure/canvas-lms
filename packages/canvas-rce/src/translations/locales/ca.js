...
const locale = {
  ...
  "alignment_and_indentation_f7de34bf": { "message": "Alineació i sagnia" },
  ...
  "an_error_occurred_generating_the_file_preview_cf259955": {
    "message": "S''ha produït un error en generar la visualització prèvia del fitxer"
  },
  ...
  "audio_and_video_recording_is_not_available_c7173efc": {
    "message": "L''enregistrament de so i vídeo no està disponible."
  },
  ...
  "canvas_plugins_705a5016": { "message": "Connectors de Canvas" },
  ...
  "click_any_page_to_insert_a_link_to_that_page_ac920c02": {
    "message": "Feu clic a qualsevol pàgina per inserir un enllaç a la pàgina en qüestió."
  },
  ...
  "directionality_ebcae6d0": { "message": "direccionalitat" },
  ...
  "drag_a_file_here_39357b48": { "message": "Arrossega un fitxer aquí" },
  ...
  "embed_video_code_703e10f2": { "message": "Integra el codi del vídeo" },
  ...
  "error_uploading_video_audio_recording_16d9730a": {
    "message": "S''ha produït un error en carregar l''enregistrament de vídeo o so"
  },
  ...
  "focus_the_popup_context_toolbar_7979f4f8": {
    "message": "Centreu-vos en la barra d''eines de context que es mostra en una finestra emergent"
  },
  ...
  "loading_media_f3455841": {
    "message": "S''està carregant l''element multimèdia"
  },
  ...
  "miscellaneous_and_apps_f450a387": {
    "message": "Miscel·lània i aplicacions"
  },
  ...
  "no_alt_text_decorative_image_f318fc0e": {
    "message": "Sense text alternatiu (imatge decorativa)"
  },
  ...
  "pause_12af3bb4": { "message": "Fes una pausa" },
  "people_b4ebb13c": { "message": "Persones" },
  "play_1a47eaa7": { "message": "Reprodueix" },
  "please_allow_canvas_to_access_your_microphone_and__dc2c3079": {
    "message": "Permeteu que Canvas accedeixi al micròfon i a la càmera web."
  },
  ...
  "reading_a_media_track_file_failed_aborting_be051b20": {
    "message": "S''ha produït un error en llegir un fitxer de seguiment multimèdia. S''està abandonant."
  },
  ...
  "right_to_left_ec223c81": { "message": "de dreta a esquerra" },
  "save_11a80ec3": { "message": "Desa" },
  "search_280d00bd": { "message": "Cerca" },
  "search_term_b2d2235": { "message": "Terme de cerca" },
  "select_app_3d08035a": { "message": "Selecciona l''aplicació" },
  ...
  "something_went_wrong_accessing_your_mic_or_webcam_6e3cad12": {
    "message": "Alguna cosa no ha anat bé en accedir al micròfon o a la càmera web."
  },
  ...
  "switch_to_raw_html_editor_4c9ac7de": {
    "message": "Canvia a un editor de dades HTML sense processar"
  },
  "switch_to_rich_text_editor_35822d26": {
    "message": "Canvia a un editor de text enriquit"
  },
  ...
  "video_audio_recording_uploaded_6af5d378": {
    "message": "S''ha penjat l''enregistrament de vídeo o so"
  },
