...
const locale = {
  ...
  "current_link_945a47ee": { "message": "現在のリンク" },
  ...
  "if_left_empty_link_text_will_display_as_course_lin_2a34eedb": {
    "message": "空欄の場合、リンクテキストはコースリンク名として表示されます。"
  },
  ...
  "image_filenames_should_not_be_used_as_the_alt_attr_bcfd7780": {
    "message": "画像ファイル名を、画像の代替テキストとして使用しないでください。"
  },
  ...
  "link_type_linktypemessage_c6d26815": {
    "message": "リンクタイプ：{ linkTypeMessage }"
  },
  ...
  "navigation_ee9af92d": { "message": "ナビゲーション" },
  ...
  "unpublished_dfd8801": { "message": "非公開" },
  ...
  "updated_link_a827e441": { "message": "アップデートされたリンク" },
