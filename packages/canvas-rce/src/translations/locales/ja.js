...
const locale = {
  ...
  "alignment_and_indentation_f7de34bf": { "message": "調節と書き出し" },
  ...
  "an_error_occurred_generating_the_file_preview_cf259955": {
    "message": "ファイルプレビューの作成中にエラーが発生しました"
  },
  ...
  "audio_and_video_recording_is_not_available_c7173efc": {
    "message": "オーディオとビデオの録音・録画は利用できません。"
  },
  ...
  "canvas_plugins_705a5016": { "message": "Canvas プラグイン" },
  ...
  "directionality_ebcae6d0": { "message": "方向" },
  ...
  "drag_a_file_here_39357b48": { "message": "ファイルをここにドラッグする" },
  ...
  "focus_the_popup_context_toolbar_7979f4f8": {
    "message": "ポップアップコンテキストツールバーに注目する"
  },
  ...
  "left_to_right_d6da6d7e": { "message": "左から右" },
  ...
  "reading_a_media_track_file_failed_aborting_be051b20": {
    "message": "メディアトラックファイルの読み取りに失敗しました。中止中。"
  },
  ...
  "something_went_wrong_accessing_your_mic_or_webcam_6e3cad12": {
    "message": "マイクまたはウェブカムにアクセス中にエラーが生じました。"
  },
  ...
  "switch_to_raw_html_editor_4c9ac7de": {
    "message": "ロー html エディタに切り替える"
  },
  "switch_to_rich_text_editor_35822d26": {
    "message": "リッチ テキスト エディタに切り替える"
  },
