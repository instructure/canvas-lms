...
const locale = {
  ...
  "align_center_ca078feb": { "message": "置中對齊" },
  "align_left_e9f1f93b": { "message": "向左對齊" },
  "align_right_9bad3ac1": { "message": "向右對齊" },
  ...
  "color_color_eb64b08": { "message": "顏色 { color }" },
  ...
  "decrease_indent_de6343ab": { "message": "減少縮排" },
  ...
  "external_links_3d9f074e": { "message": "外部連結" },
  ...
  "increase_indent_6d550a4a": { "message": "增加縮排" },
  "insert_593145ef": { "message": "插入" },
  "insert_equella_links_49a8dacd": { "message": "插入 Equella 連結" },
  ...
  "language_arts_35b79a8b": { "message": "語言文學" },
  ...
  "load_more_results_460f49a9": { "message": "載入更多結果" },
