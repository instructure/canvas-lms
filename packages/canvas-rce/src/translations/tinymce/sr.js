...
tinymce.addI18n('sr', {
  ...
  'Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
    'Id treba da po\u010dinje slovom, pra\u0107eno samo slovima, brojevima, crticama, ta\u010dkama, dvota\u010dkom ili donjim crtama',
  ...
  'Find (if searchreplace plugin activated)':
    'Prona\u0111i (ako je dodatak pretrage i zamene aktiviran)',
