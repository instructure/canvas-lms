...
const locale = {
  ...
  "chinese_simplified_7f0bd370": { "message": "Kínai egyszerűsített" },
  "chinese_traditional_8a7f759d": { "message": "Kínai (hagyományos)" },
  ...
  "filipino_33339264": { "message": "filippínó" },
  ...
  "norwegian_nynorsk_c785f8a6": { "message": "norvég Nynorsk" },
  "persian_a8cadb95": { "message": "perzsa" },
  ...
  "the_selected_file_exceeds_the_maxsize_byte_limit_f7e8c771": {
    "message": "A kiválasztott fájl meghaladja a { maxSize } bájtkorlátot"
  },
