...
$(document).ready(function() {
  ...
  $('#edit_page_sidebar .add_content_link').click(function(event) {
    ...
    var $section = $('#page_section_blank')
      .clone(true)
  ...
  $('#page_content')
    ...
    .delegate('.select_submission_button', 'click', function(event) {
      ...
      var $frame = $('#edit_content_templates')
    ...
    .delegate('.upload_file_button', 'click', function(event) {
      ...
      var $section = $(this).parents('.section')
      var $message = $('#edit_content_templates')
        .find('.uploading_file')
        .clone()
      var $upload = $(this)
        .parents('.section')
      ...
      if (!data.uploaded_data) {
        ...
        if ($file.length > 0) {
          ...
          if ($file.hasClass('image')) {
            var $image = $('#eportfolio_view_image')
              .clone(true)
              .removeAttr('id')
            $image
            ...
            var $download = $('#eportfolio_download_file')
              .clone(true)
              .removeAttr('id')
...
$(document).ready(function() {
  ...
  $('.move_page_link').click(function(event) {
    ...
    var otherPages = $('#page_list .page')
      .not(page)
      .not('#page_blank')
      .toArray()
    var destinations = otherPages.map(function(otherPage) {
      return {
...
$(document).ready(function() {
  ...
  $('.move_section_link').click(function(event) {
    ...
    var otherSections = $('#section_list .section')
      .not(section)
      .not('#section_blank')
      .toArray()
    var destinations = otherSections.map(function(otherSection) {
      return {
