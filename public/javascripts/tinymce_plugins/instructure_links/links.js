...
import RceCommandShim from 'jsx/shared/rce/RceCommandShim';
 ...
 */
export function buttonToImg (target) {
 ...
 */
export function prepEditorForDialog (editor) {
  editor.nodeChanged();
 ...
 *   above
 */
export function buildLinkClasses (priorClasses, $box) {
 ...
 */
export function bindLinkSubmit ($box, linkableEditor, fetchClasses, done) {
...
export function renderDialog (ed) {
...
export function updateLinks (ed, arg) {
