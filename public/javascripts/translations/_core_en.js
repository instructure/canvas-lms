...
setLazyTranslations('en', 'date', null, function () {
  return {
    ...
    datepicker: {column_headings: ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa']},
    day_names: ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
    days: {today: 'Today', today_lower: 'today', tomorrow: 'Tomorrow', yesterday: 'Yesterday'},
    formats: {
...
setLazyTranslations('en', 'time', null, function () {
  return {
    am: 'am',
    formats: {
...
setLazyTranslations('en', 'number', null, function () {
  return {
    currency: {
      format: {
        delimiter: ',',
    ...
    nth: {ordinalized: {}, ordinals: {}},
    percentage: {format: {delimiter: '', format: '%n%'}},
    precision: {format: {delimiter: ''}}
  }
})

setLazyTranslations('en', 'datetime', null, function () {
  return {
    distance_in_words: {
...
setLazyTranslations('en', 'support', null, function () {
  return {
    array: {
      last_word_connector: ', and ',
      or: {last_word_connector: ', or ', two_words_connector: ' or '},
    ...
    help_menu: {
      ...
      global_support_desk_description:
        'Our ASCs are your first line of support, and can connect you with our Global Support Desk for issues that require additional assistance.',
      ...
      student_support: 'NetAcad Support - Student',
      student_support_description:
        'Your Instructor should be your first point of contact. They can answer your Networking Academy questions or contact the support desk for you. You can contact your instructor by using the Inbox feature.',
