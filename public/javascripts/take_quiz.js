...
var quizSubmission = (function() {
  ...
  return {
    ...
    updateTime: function() {
      var currentTimeLeft = (quizSubmission.timeLeft =
        quizSubmission.timeLeft - quizSubmission.clockInterval)
      var currentTimeToDueDate = null
      if (quizSubmission.timeToDueDate > 0) {
        currentTimeToDueDate = quizSubmission.timeToDueDate =
          quizSubmission.timeToDueDate - quizSubmission.clockInterval
      }
      var now = new Date()
