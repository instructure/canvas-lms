...
$.extend(Datepicker.prototype, {
  ...
  _dialogDatepicker: function(input, date, onSelect, settings, pos) {
    ...
    if (!this._pos) {
      ...
      this._pos = [browserWidth / 2 - 100 + scrollX, browserHeight / 2 - 150 + scrollY] // should use actual width/height below
    }
  ...
  _generateHTML: function(inst) {
    ...
    var prev = this._canAdjustMonth(inst, -1, drawYear, drawMonth)
      ...
      : hideIfNoPrevNext
        ? ''
        : '<span class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' +
          prevText +
          '"><span class="ui-icon ui-icon-circle-triangle-' +
          (isRTL ? 'e' : 'w') +
          '">' +
    ...
    var next = this._canAdjustMonth(inst, +1, drawYear, drawMonth)
      ...
      : hideIfNoPrevNext
        ? ''
        : '<span class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' +
          nextText +
          '"><span class="ui-icon ui-icon-circle-triangle-' +
          (isRTL ? 'w' : 'e') +
          '">' +
  ...
  _adjustInstDate: function(inst, offset, period) {
    ...
    var day =
      Math.min(inst.selectedDay, this._getDaysInMonth(year, month)) + (period == 'D' ? offset : 0)
