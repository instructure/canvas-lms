...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		buildtracks: function(player, controls, layers, media) {
			...
			// ISNTRUCTURE added code (the '&& !player.options.can_add_captions' part)
			showAddCaptionLink = player.options.can_add_captions && window.FileReader
			if (player.tracks.length == 0 && !showAddCaptionLink)
				return;
			...
			// ISNTRUCTURE added code
			if (showAddCaptionLink) player.addUploadTrackButton();
