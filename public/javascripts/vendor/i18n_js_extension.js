...
;(function e(t, n, r) {
...
})(
  {
        ...
        ;(function() {
          ...
          var getSlug = function getSlug(input, opts) {
            ...
            var customReplacements =
              typeof opts === 'object' && typeof opts.custom === 'object' && opts.custom
                ? opts.custom
                : {}
            var separator = (typeof opts === 'object' && opts.separator) || '-'
            var truncate =
              (typeof opts === 'object' && +opts.truncate > 1 && opts.truncate) || false
            ...
            var symbol =
              typeof opts === 'object' && opts.lang && symbolMap[opts.lang]
                ? symbolMap[opts.lang]
                : typeof opts === 'object' && (opts.lang === false || opts.lang === true)
                  ? {}
                  : symbolMap.en
            var uricChars = [';', '?', ':', '@', '&', '=', '+', '$', ',', '/']
            ...
            if (
              titleCase &&
              typeof titleCase.length === 'number' &&
              Array.prototype.toString.call(titleCase)
            ) {
    ...
    5: [
        ...
        var CallHelpers = {
          ...
          inferPluralizationHash: function(defaultValue, translateOptions) {
            if (
              ...
              defaultValue.match(/^[\w-]+$/) &&
              translateOptions &&
              'count' in translateOptions
            ) {
          ...
          validDefault: function(allowBlank) {
            ...
            return (
              (allowBlank && (typeof defaultValue === 'undefined' || defaultValue === null)) ||
              typeof defaultValue === 'string' ||
          ...
          inferArguments: function(args, meta) {
            ...
            if (!hasKey) args.unshift(this.inferKey(args[0]))
            var defaultOrOptions = args[1]
            if (
              args[2] ||
              typeof defaultOrOptions === 'string' ||
              this.isPluralizationHash(defaultOrOptions)
            ) {
      ...
      {'./i18nliner': 8, './pluralize': 9, './utils': 10, crc32: 1, speakingurl: 3}
    ],
    6: [
      function(require, module, exports) {
        'use strict'
