  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      if (options.numberOfColumnsToFreeze > 0) {
        ...
        $headers_0 = $(
          "<div class='headers_0 slick-header-columns' style='left:-1000px' />"
      ...
      $headers_1 = $(
        "<div class='headers_1 slick-header-columns' style='left:-1000px' />"
    ...
    function appendRowHtml(stringArray, row, range, dataLength) {
      ...
      for (var i = 0, ii = columns.length; i < ii; i++) {
        ...
        } else if (columnPosRight[Math.min(ii - 1, i + colspan - 1)] > range.leftPx) {
          // Do not render cells outside of viewport_1.
