...
$('.add_federated_attribute_button').click(function(event) {
  ...
  var checkbox_name =
    'authentication_provider[federated_attributes][' +
    canvas_attribute_html +
    '][provisioning_only]'
  ...
  var provider_attribute_name =
    'authentication_provider[federated_attributes][' + canvas_attribute_html + '][attribute]'
...
$('.jit_provisioning_checkbox').click(function() {
  var $provisioning_elements = $(this)
