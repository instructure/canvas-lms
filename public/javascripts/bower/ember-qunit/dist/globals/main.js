      ...
      2: [
        function(_dereq_, module, exports) {
          ...
          var isolatedContainer =
            _dereq_('./isolated-container')['default'] || _dereq_('./isolated-container')
          var moduleFor = _dereq_('./module-for')['default'] || _dereq_('./module-for')
          var moduleForComponent =
            _dereq_('./module-for-component')['default'] || _dereq_('./module-for-component')
          var moduleForModel =
            _dereq_('./module-for-model')['default'] || _dereq_('./module-for-model')
      ...
      3: [
        function(_dereq_, module, exports) {
          ...
          exports['default'] = function moduleForComponent(name, description, callbacks) {
            ...
            moduleFor('component:' + name, description, callbacks, function(
              container,
              context,
              defaultSubject
            ) {
      ...
      4: [
        function(_dereq_, module, exports) {
          ...
          exports['default'] = function moduleForModel(name, description, callbacks) {
            moduleFor('model:' + name, description, callbacks, function(
              container,
              context,
              defaultSubject
            ) {
