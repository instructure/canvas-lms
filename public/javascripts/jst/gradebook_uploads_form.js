...
templates['gradebook_uploads_form'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  stack1 = "You Must have <em>all</em> of these columns, you only <em>need</em> one per row.";
  ...
  stack1 = "Leaving the ID (the \"(581)\" part in this case) in tact will help match better. You can also add new assignments that will be created on the fly.";
  ...
  stack2 = "existing_assignment_assignment_id";
  stack3 = {};
  stack4 = "gradebook_uploads_form";
  stack3['scope'] = stack4;
  stack4 = helpers['t'] || depth0['t'];
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</th>\n          <th>Current Score</th>\n          <th>Final Score</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr>\n          <td colspan=\"2\">Points Possible</td>\n          <td></td>\n          <td></td>\n          <td></td>\n          <td>50</td>\n          <td>10</td>\n          <td></td>\n          <td></td>\n        </tr>\n        <tr>\n          <td>Smith, John</td>\n          <td>12345</td>\n          <td>2122</td>\n          <td>12321</td>\n          <td>night</td>\n          <td>46</td>\n          <td>8</td>\n          <td></td>\n          <td></td>\n        </tr>\n        <tr>\n          <td>King, Ben</td>\n          <td></td>\n          <td></td>\n          <td></td>\n          <td></td>\n          <td>34</td>\n          <td>60</td>\n          <td></td>\n          <td></td>\n        </tr>\n        <tr>\n          <td></td>\n          <td>12347</td>\n          <td></td>\n          <td></td>\n          <td></td>\n          <td>38</td>\n          <td>3</td>\n          <td></td>\n          <td></td>\n        </tr>\n        <tr>\n          <td></td>\n          <td></td>\n          <td>123</td>\n          <td></td>\n          <td></td>\n          <td>40</td>\n          <td></td>\n          <td></td>\n          <td></td>\n        </tr>\n        <tr>\n          <td></td>\n          <td></td>\n          <td></td>\n          <td>3232</td>\n          <td></td>\n          <td>44</td>\n          <td>7</td>\n          <td></td>\n          <td></td>\n        </tr>\n      </tbody>\n    </table>\n    <p>If in doubt, you can always <a href=\"";
  stack1 = helpers.download_gradebook_csv_url || depth0.download_gradebook_csv_url;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "download_gradebook_csv_url", { hash: {} }); }
  buffer += escapeExpression(stack1) + "\">download a CSV</a>, change the grades you want and re-upload the same file.</p>\n  </div>\n\n  <p style=\"font-size: 1.2em;\">\n    <label for=\"gradebook_upload_uploaded_data\">";
  stack1 = "Choose a CSV file to upload:";
