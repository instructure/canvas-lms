(function() {
  ...
  this.AssignmentGroupWeightsDialog = AssignmentGroupWeightsDialog = (function() {
    function AssignmentGroupWeightsDialog(options) {
      ...
      this.render = __bind(this.render, this);      this.$dialog = $('#assignment_group_weights_dialog');
      this.$dialog.dialog({
        autoOpen: false,
        modal: true,
        resizable: false,
