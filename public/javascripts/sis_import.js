        ...
        function(data) {
          ...
          if (!sis_batch || sis_batch.workflow_state == 'imported') {
            ...
            var message = I18n.t(
              ...
              'There was an error importing your SIS data. No records were imported.  Please notify your system administrator and give them the following code: "%{code}"',
              {code: code}
            )
