...
define([
  ...
  $(function() {
    ...
    // make sure that #content is at least as big as the tallest of #left_side and ALWAYS at least 500px tall
    $('#content:not(.already_sized)').css({"minHeight" : $("#left-side").outerHeight()});
