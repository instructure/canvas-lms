...
export function LtiAssetReportsMissingReportsCard(): JSX.Element {
  return (
    <View
      as="div"
      borderColor="primary"
      ...
      borderWidth="small"
      padding="small"
      aria-label={I18n.t('No reports from Document Processing App')}
    >
      <Flex direction="column" gap="xx-small">
        <Flex.Item>
          <Text as="div" size="small">
            <IconInfoSolid inline={true} style={{paddingRight: '0.3em'}} />
            {I18n.t('The document processor has not returned any reports for this file.')}
          </Text>
        </Flex.Item>
      </Flex>
    </View>
...
export function LtiAssetReportsCard({report}: {report: LtiAssetReport}): JSX.Element {
