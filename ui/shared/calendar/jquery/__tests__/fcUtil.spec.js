...
describe('Calendar', () => {
  ...
  test('addMinuteDelta: works with no DST shift', () => {
    ...
    expect(tz.format(fcUtil.unwrap(datetime2), '%FT%T%z')).toBe('2017-01-02T00:00:00-0700')
  ...
  test('addMinuteDelta: works across DST -> standard shift', () => {
    ...
    datetime2 = fcUtil.addMinuteDelta(datetime1, -1440)
    expect(tz.format(fcUtil.unwrap(datetime2), '%FT%T%z')).toBe('2017-03-12T00:00:00-0700')
  })
})
