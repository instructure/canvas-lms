...
// and causes timeouts in CI even when isolated. The cancel dialog functionality
// is covered by:
// - RegenerateCriteria component tests (ui/shared/rubrics/react/RubricForm/components/AIGeneratedCriteria/__tests__/)
// - The modal's cancel button is a standard InstUI component behavior
describe('RubricForm AI Regenerate Cancel Dialog Test', () => {
  ...
  it.skip('closes the regenerate dialog when cancel is clicked', async () => {
