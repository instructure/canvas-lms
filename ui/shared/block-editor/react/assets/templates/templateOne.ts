...
export const templateOne = {
  ...
  ftVtiCUI_K: {
    ...
    isCanvas: false,
    props: {background: '#f9faff'},
    displayName: 'Hero',
    custom: {isSection: true},
    parent: 'ROOT',
    hidden: false,
    nodes: [],
    linkedNodes: {'hero-section_nosection1': 'TFTTybCaAT', 'hero-section_nosection2': 'QvgT9JPBaT'},
  },
  TFTTybCaAT: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'hero-section__inner-start'},
    displayName: 'Column',
  ...
  ZODdPQOlw9: {
    type: {resolvedName: 'HeroTextHalf'},
    isCanvas: true,
    props: {id: 'hero-section_text', color: '#2d3b45'},
    displayName: 'Hero Text',
    custom: {noToolbar: true},
    parent: 'TFTTybCaAT',
    hidden: false,
    nodes: [],
    linkedNodes: {'hero-section_text__no-section': '2j86G5Fu6D'},
  },
  '2j86G5Fu6D': {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'text-half__inner'},
    displayName: 'Column',
    custom: {noToolbar: true},
    parent: 'ZODdPQOlw9',
    hidden: false,
  ...
  JkDTjDAKDv: {
    ...
    isCanvas: false,
    props: {level: 'h2', id: 'hero-section_text__title', text: 'Welcome to Class!'},
    displayName: 'Heading',
    custom: {
      themeOverride: {
  ...
  QvgT9JPBaT: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'hero-section__inner-end'},
    displayName: 'Column',
    custom: {noToolbar: true},
    parent: 'ftVtiCUI_K',
    hidden: false,
  ...
  OuvSAcbSnM: {
    ...
    props: {
      ...
      src: 'http://canvas-web.inseng.test/users/1/files/128/preview?annotate=0&verifier=oYEmOkvVsNecs18dS6O4cYmCjfebXXiu5NypDVVE',
    },
    displayName: 'Image',
    custom: {},
    parent: 'QvgT9JPBaT',
  ...
  rXCSp2TzpG: {
    type: {resolvedName: 'NavigationSection'},
    isCanvas: false,
    props: {background: '#334870'},
    displayName: 'Navigation',
    custom: {isSection: true},
    parent: 'ROOT',
    hidden: false,
    nodes: [],
    linkedNodes: {'navigation-section__inner': 'o-y7Qs08R_'},
  },
  'o-y7Qs08R_': {
    type: {resolvedName: 'NavigationSectionInner'},
    isCanvas: true,
    props: {},
    displayName: 'Navigation',
    custom: {noToolbar: true},
  ...
  Q5FJbp_nx0: {
    type: {resolvedName: 'AnnouncementSection'},
    isCanvas: false,
    props: {},
  ...
  hg7VcyyOiz: {
    type: {resolvedName: 'AboutSection'},
    isCanvas: false,
    props: {background: '#f9faff'},
    displayName: 'About',
    custom: {isSection: true},
  ...
  jyicoKs7qk: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'about-section__inner-end'},
    displayName: 'Column',
    custom: {noToolbar: true},
    parent: 'hg7VcyyOiz',
    hidden: false,
  ...
  LzyysA_swe: {
    ...
    props: {
      ...
      src: 'http://canvas-web.inseng.test/users/1/files/129/preview?annotate=0&verifier=Ao7mjfgnG6drgLRSu46LlhBRDmWpU6SpejlordGH',
    },
    displayName: 'Image',
    custom: {},
    parent: 'jyicoKs7qk',
  ...
  YrwdgUaTRG: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'about-section__inner-start'},
    displayName: 'Column',
    custom: {noToolbar: true},
    parent: 'hg7VcyyOiz',
    hidden: false,
  ...
  konjDVAaZJ: {
    type: {resolvedName: 'AboutTextHalf'},
    isCanvas: true,
    props: {id: 'about-section_text', color: '#2d3b45'},
    displayName: 'About Text',
    custom: {},
    parent: 'YrwdgUaTRG',
    hidden: false,
    nodes: [],
    linkedNodes: {'about-section_text__no-section': 'I8oiXTLl0M'},
  },
  I8oiXTLl0M: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
  ...
  '2L-ALGn5zs': {
    type: {resolvedName: 'HeadingBlock'},
    isCanvas: false,
    props: {level: 'h2', id: 'about-section_text__title', text: "Teacher's Note"},
    displayName: 'Heading',
    custom: {
      themeOverride: {
        h2FontFamily: 'Georgia, LatoWeb, Lato, "Helvetica Neue", Helvetica, Arial, sans-serif',
  ...
  bD1vrkQK2M: {
    type: {resolvedName: 'NoSections'},
    isCanvas: true,
    props: {className: 'footer-section__inner'},
    displayName: 'Column',
    custom: {noToolbar: true},
    parent: 'tXFIeZJxP0',
    hidden: false,
  ...
  tXFIeZJxP0: {
    type: {resolvedName: 'FooterSection'},
    isCanvas: false,
    props: {background: '#0A0189'},
    displayName: 'Footer',
    custom: {isSection: true},
    parent: 'ROOT',
    hidden: false,
    nodes: [],
    linkedNodes: {'hero-section__footer-no-section': 'bD1vrkQK2M'},
  },
  OFr82Vq31Y: {
    type: {resolvedName: 'TextBlock'},
    isCanvas: false,
