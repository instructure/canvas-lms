...
describe('Notification Preferences Table - Reported Reply - Teacher', () => {
  beforeEach(() => {
    fakeENV.setup({
      ...
      discussions_reporting: false, // Reporting disabled
    })
  })
  ...
  it('does not show the notification preference when reporting is disabled', () => {
