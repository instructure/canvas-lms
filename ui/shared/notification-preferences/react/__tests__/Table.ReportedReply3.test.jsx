...
describe('Notification Preferences Table - Reported Reply - Teacher with Reporting', () => {
  beforeEach(() => {
    fakeENV.setup({
      ...
      discussions_reporting: true, // Reporting enabled
    })
  })
  ...
  it('shows the notification preference when reporting is enabled', () => {
