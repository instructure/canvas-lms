...
QUnit.module('inlineMediaComment', hooks => {
  hooks.beforeEach(() => {
  ...
  QUnit.skip('anchor tag with proper class triggers media load when clicked', function () {
  ...
  QUnit.skip('video in td has minimum size of 300', function () {
    fixtures.innerHTML =
