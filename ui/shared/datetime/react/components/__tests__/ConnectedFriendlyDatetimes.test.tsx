...
describe('ConnectedFriendlyDatetimes', () => {
  const defaultProps = {
    firstDateTime: '2023-07-10T23:00:00-00:00',
    secondDateTime: '2023-07-22T23:00:00-00:00',
  }

  it('it renders when the dates are strings', () => {
    const {getAllByText} = render(<ConnectedFriendlyDatetimes {...defaultProps} />)

    expect(getAllByText('Jul 10, 2023 Jul 22, 2023')).toHaveLength(2)
  })

  it('it renders when the dates are Dates', () => {
    const props = {
      firstDateTime: new Date('2023-07-10T23:00:00-00:00'),
      secondDateTime: new Date('2023-07-22T23:00:00-00:00'),
    }
  ...
  it('renders a prefix', () => {
    ...
    expect(getAllByText('yo: Jul 10, 2023 Jul 22, 2023')).toHaveLength(2)
  })
  ...
  it('renders a mobile prefix', () => {
    ...
    expect(getAllByText('mobile: 7/10/2023 7/22/2023')).toHaveLength(1)
  })

  it('renders a connector', () => {
    const {getAllByText} = render(<ConnectedFriendlyDatetimes connector="to" {...defaultProps} />)

    expect(getAllByText('Jul 10, 2023 to Jul 22, 2023')).toHaveLength(2)
  })
  ...
  it('renders a mobile connector', () => {
    ...
    expect(getAllByText('7/10/2023 mobile 7/22/2023')).toHaveLength(1)
  })
  ...
  it('shows the time when requested', () => {
    ...
    expect(getAllByText('Jul 10 at 11pm Jul 22 at 11pm')).toHaveLength(2)
  })
  ...
  it('it uses a specified format', () => {
    ...
    expect(getAllByText('Jul 10, 2023 11:00pm Jul 22, 2023 11:00pm')).toHaveLength(2)
  })
})
