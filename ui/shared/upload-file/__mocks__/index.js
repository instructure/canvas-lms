...
// Manual mock for @canvas/upload-file
...
export const submissionCommentAttachmentsUpload = mockFn().mockResolvedValue([])
export const uploadFiles = mockFn().mockResolvedValue([])
