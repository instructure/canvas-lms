...
type PeerReviewAvailableFromDateTimeInputProps = CustomDateTimeInputProps & {
...
const PeerReviewAvailableFromDateTimeInput = ({
  ...
  disabled,
  ...rest
}: PeerReviewAvailableFromDateTimeInputProps) => {
  const key = 'peer_review_available_from'
  ...
  const messages = useMemo(
    ...
    [peerReviewAvailableFromDate, validationErrors, key, unparsedFieldKeys],
  )
  ...
  return (
    <ClearableDateTimeInput
      id={key}
      disabled={disabled}
      description={I18n.t('Choose a peer review available from date and time')}
      dateRenderLabel={I18n.t('Reviewing Starts')}
      value={peerReviewAvailableFromDate}
      onChange={handlePeerReviewAvailableFromDateChange}
      onClear={handleClear}
      messages={messages}
      onBlur={onBlur}
...
export default PeerReviewAvailableFromDateTimeInput
