...
QUnit.module('flash alert tests', function (hooks) {
  ...
  // cf. FOO-4521
  QUnit.skip('forces ENV.flashAlertTimeout if variable is set', () => {
  ...
  // cf. FOO-4521
  QUnit.skip('respects timeout parameter if ENV.flashAlertTimeout variable is not set', () => {
    const desiredTimeout = 100
    helper.initHolder()
  ...
  // cf. FOO-4521
  QUnit.skip(
    'respects default timeout parameter of 7000 milliseconds if ENV.flashAlertTimeout OR parameter variables are not set',
    () => {
