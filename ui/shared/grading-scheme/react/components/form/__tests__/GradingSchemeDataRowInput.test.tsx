...
const onRowLetterGradeChange = vi.fn()
const onLowRangeChange = vi.fn()
const onLowRangeBlur = vi.fn()
const onHighRangeChange = vi.fn()
const onHighRangeBlur = vi.fn()
const onRowDeleteRequested = vi.fn()
const onRowAddRequested = vi.fn()
