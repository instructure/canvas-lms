...
const GradingSchemeDeleteModal = ({
  ...
  return (
    <Modal
      ...
      label={t('Delete ') + selectedGradingScheme.title}
      size="small"
    ...
    >
      <Modal.Header>
        ...
        <Heading data-testid="grading-scheme-delete-modal-title">
          <TruncateText>{t('Delete ') + selectedGradingScheme.title}</TruncateText>
        </Heading>
      </Modal.Header>
      <Modal.Body>{t('Are you sure you want to delete this grading scheme?')}</Modal.Body>
      <Modal.Footer>
