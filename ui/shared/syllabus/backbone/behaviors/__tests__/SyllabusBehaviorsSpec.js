...
QUnit.skip('sets focus to the edit button when hide_edit occurs', () => {
...
QUnit.skip('sets syllabus_body data value on fresh node when showing edit form', () => {
...
QUnit.skip('sets course_syllabus_body after mce destruction', () => {
...
QUnit.skip('hides student view button when editing syllabus', () => {
  fixtures.create('<a href="#" class="edit_syllabus_link">Edit Link</a>')
  fixtures.create('<form id="edit_course_syllabus_form"></form>')
...
QUnit.skip('jumps to the events when events have no dates and user clicks "Jump to Today"', () => {
...
QUnit.skip(
  'jumps to the first event when all events are future and user clicks "Jump to Today"',
  () => {
    fixtures.create(
...
QUnit.skip(
  'jumps to most recent past event when there are past, future, and dateless events and user clicks "Jump to Today"',
  () => {
    fixtures.create(
...
QUnit.skip(
  'jumps to most recent past event when there are only past events and user clicks "Jump to Today"',
  () => {
    fixtures.create(
      '<tr id="test1" class="date detail_list events_2000_07_28 syllabus_assignment related-assignment_4" data-workflow-state="published"><td scope="row" rowspan="1" valign="top" class="day_date" data-date="2000_07_28">Thu Jul 28, 2000</td></tr>'
    )
...
QUnit.skip('escapes selector when jumping to event', () => {
