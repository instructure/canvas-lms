...
import {Alert as AssignmentAlert} from '@instructure/ui-alerts'
...
export const DiscussionTopicContainer = ({createDiscussionEntry, ...props}) => {
  ...
  return (
    <>
      ...
      {discussionTopicData.groupSet && discussionTopicData.assignment?.onlyVisibleToOverrides && (
        <View as="div" margin="none none small" width="80%" data-testid="differentiated-alert">
          <AssignmentAlert renderCloseButtonLabel="Close">
            {I18n.t(
