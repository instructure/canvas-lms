...
export const DiscussionTranslationModuleContainer = () => {
  ...
  const {setShowTranslationControl} = useContext(
    DiscussionManagerUtilityContext
  )
  ...
  return (
    <View position="relative" borderColor="primary" as="div" borderRadius="medium" borderWidth="small" padding="large" margin="medium 0 0 0">
      <Heading level="h3">{I18n.t('Translate Discussion')}
        <span style={{float: "right"}}>
          <IconButton size="small" onClick={closeTranslationsModule}  withBackground={false} withBorder={false} screenReaderLabel={I18n.t('Close translations module')}>
            <IconEndLine />
          </IconButton>
        </span>
      </Heading>
      ...
      <Flex padding="medium 0 0 0" direction="row" alignItems="end" gap="small" wrap="wrap">
        <Flex.Item>
          <TranslationControls setTranslationLanguage={(languageId) => {setTranslationLanguageId(languageId)}}/>
        </Flex.Item>
        <Flex.Item>
          <Button onClick={translateDiscussion} margin="0 small 0 0" renderIcon={<AiIcon/>} color="primary">{I18n.t('Translate')}</Button>
