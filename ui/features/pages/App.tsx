...
import {BlockContentEditorWrapper} from './react/components/BlockContentEditorWrapper'
...
export const App = () => {
  ...
  return (
    <MainLayout
      header={<Heading variant="titlePageDesktop">{t('Block Content Editor')}</Heading>}
