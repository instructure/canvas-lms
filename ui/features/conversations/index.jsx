...
import MessageDetailView from './backbone/views/MessageDetailView'
import MessageFormDialog from './backbone/views/MessageFormDialog'
import SubmissionCommentFormDialog from './backbone/views/SubmissionCommentFormDialog'
import InboxHeaderView from './backbone/views/InboxHeaderView'
import deparam from 'deparam'
import CourseCollection from './backbone/collections/CourseCollection'
import FavoriteCourseCollection from './backbone/collections/FavoriteCourseCollection'
