...
// Related tests split into:
// - DiscussionTopicFormCheckpointsAllowedRange.test.jsx
// - DiscussionTopicFormCheckpointsOutsideRange.test.jsx
describe('DiscussionTopicForm Checkpoints Additional Replies', () => {
  beforeEach(() => {
    setupDefaultEnv()
  })
