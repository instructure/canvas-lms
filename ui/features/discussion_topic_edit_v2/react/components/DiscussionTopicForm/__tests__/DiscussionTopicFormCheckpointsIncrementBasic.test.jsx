...
// Skipped: Times out in CI even when isolated. The range test in
// DiscussionTopicFormCheckpointsIncrementRange.test.jsx exercises the same
// increment/decrement functionality while also testing boundary conditions.
describe.skip('DiscussionTopicForm Checkpoints Increment Basic', () => {
  beforeEach(() => {
    setupDefaultEnv()
  })
