...
// I hate having to mock as opposed to just using testing library
// but the way that $.screenReaderFlashError is written means that
// we have to do it this way. Otherwise, we have to insert the node
// that it's expecting.
const mockedFlash = jest.fn()
const originalFlash = $.screenReaderFlashError
$.screenReaderFlashError = mockedFlash

afterAll(() => {
  $.screenReaderFlashError = originalFlash
})
