...
export const handleMoveContents = (
  id: string,
  name: string,
  data: InfiniteData<ModulesResponse>,
  ...
  const moveTrayProps = {
    ...
    moveOptions: {
      excludeCurrent: true,
      groups: allModules.map(module => ({
        id: module._id,
        title: module.name,
        items: [] // TODO: this part is more complex because we need every module and every module's items
      })),
      groupsLabel: "Modules"
    },
    ...
    focusOnExit: () => {}, // TODO: implement focusOnExit
  }

  renderTray(moveTrayProps)
}

export const handleMoveModule = (
  id: string,
  name: string,
  data: InfiniteData<ModulesResponse>,
  courseId: string,
  ...
  const moveTrayProps = {
    ...
    moveOptions: {
      siblings: allModules.map(module => ({
        id: module._id,
        title: module.name
      })),
      groupsLabel: "Modules"
