...
describe('GradebookGrid StudentColumnHeader', () => {
  ...
  beforeEach(() => {
    ...
    props = {
      ...
      disabled: false,
      onMenuDismiss: vi.fn(),
      onSelectPrimaryInfo: vi.fn(),
      onSelectSecondaryInfo: vi.fn(),
      onToggleEnrollmentFilter: vi.fn(),
      ...
      sortBySetting: {
        ...
        disabled: false,
        isSortColumn: true,
        onSortByIntegrationId: vi.fn(),
        onSortByLoginId: vi.fn(),
        onSortBySisId: vi.fn(),
        onSortBySortableName: vi.fn(),
        onSortInAscendingOrder: vi.fn(),
        onSortInDescendingOrder: vi.fn(),
        onSortBySortableNameAscending: vi.fn(),
        onSortBySortableNameDescending: vi.fn(),
