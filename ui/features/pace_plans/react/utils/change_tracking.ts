...
export const summarizeItemChanges = (itemChanges: Change<PacePlanItem>[]): SummarizedChange[] =>
  itemChanges.map(c => ({
    id: c.id,
...
export const summarizeChanges = (settingChanges: Change[], itemChanges: Change<PacePlanItem>[]) => [
  ...summarizeSettingChanges(settingChanges),
  ...summarizeItemChanges(itemChanges)
]
