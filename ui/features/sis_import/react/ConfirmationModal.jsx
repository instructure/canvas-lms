  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <div>
          {I18n.t('Please confirm you want to move forward with these changes.')}
        </div>
      </Modal.Body>
      <Modal.Footer>
        ...
        <Button id="confirmation_modal_confirm" color="primary" onClick={onSubmit}>{I18n.t('Confirm')}</Button>
      </Modal.Footer>
    </Modal>
  );
}
