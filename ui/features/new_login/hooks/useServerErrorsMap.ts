...
export const useServerErrorsMap = (passwordPolicy?: PasswordPolicy): Record<string, string> => {
  return {
    ...
    'pseudonym.unique_id.too_long': I18n.t('Username must be %{max} characters or fewer.', {
      max: 100,
    }),
    ...
    'pseudonym.sis_user_id.too_long': I18n.t('SIS ID must be %{max} characters or fewer.', {
      max: 255,
    }),
    ...
    'pseudonym.password.too_short': passwordPolicy?.minimumCharacterLength
    ...
    'pseudonym.password.too_long': passwordPolicy?.maximumCharacterLength
    ...
    'pseudonym.password.repeated': passwordPolicy?.maxRepeats
