...
import I18n from 'i18n!blueprint_MasterChildStack'
      ...
      <div className={classes}>
        <header>
          <Text as="p" size="small">
            {isMaster ? I18n.t('Blueprint') : I18n.t('Your Course')}
          </Text>
        </header>
        <Text as="p">
          {termName} - {course.name}
        </Text>
        <div className="bcc__master-child-stack__box__footer">
          <Text size="small" color={isMaster ? 'secondary-inverse' : 'secondary'}>
