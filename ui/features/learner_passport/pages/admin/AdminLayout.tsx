...
export const Component = () => {
  ...
  const pathMatch = useMatch('/users/:userId/passport/admin/:tabPath/*')
  const selectedTab = pathMatch?.params.tabPath || 'pathways'
  ...
  const handleTabChange = (tabname: string) => {
    if (tabname === 'pathways') {
      ...
      navigate('achievements/dashboard')
    } else if (tabname === 'learner_records') {
      navigate('learner_records/dashboard')
    } else if (tabname === 'institution_settings') {
      navigate('institution_settings/dashboard')
    } else {
      navigate(tabname)
    }
  }
