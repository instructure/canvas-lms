...
export const ZInternalLtiConfiguration = z.object({
  ...
  custom_fields: z.record(z.string()).nullable(),
  target_link_uri: z.string(),
  domain: z.string().nullable(),
  tool_id: z.string().nullable(),
  privacy_level: ZLtiPrivacyLevel.nullable(),
  oidc_initiation_url: z.string(),
  oidc_initiation_urls: z.record(z.string(), z.string()).nullable(),
  public_jwk: ZPublicJwk.nullable(),
  public_jwk_url: z.string().nullable(),
  scopes: z.array(ZLtiScope),
  redirect_uris: z.array(z.string()).nullable(),
  launch_settings: ZInternalBaseLaunchSettings.nullable(),
