...
describe "QTI 2.1 zip" do
  ...
  it "should have file paths" do
    ...
    @exporter.course[:export_folder_path].index('spec/fixtures/qti/qti_qti_2_1/oi').should_not be_nil
    @exporter.course[:full_export_file_path].index('spec/fixtures/qti/qti_qti_2_1/oi/course_export.json').should_not be_nil
  end
  ...
  it "should properly detect whether a package is QTI 2.1" do
    ...
    Qti::QtiExporter.is_qti_2(qti1).should be_false
    Qti::QtiExporter.is_qti_2(qti2).should be_true
  end
