...
define('rsvp/all_settled', ['./promise', './utils', 'exports'], function(
  __dependency1__,
  __dependency2__,
  __exports__
) {
...
define('rsvp/hash', ['./promise', './utils', 'exports'], function(
  __dependency1__,
  __dependency2__,
  __exports__
) {
...
define('rsvp/map', ['./promise', './utils', 'exports'], function(
  __dependency1__,
  __dependency2__,
  __exports__
) {
...
define('rsvp/node', ['./promise', './utils', 'exports'], function(
  __dependency1__,
  __dependency2__,
  __exports__
) {
  ...
  __exports__['default'] = function denodeify(nodeFunc, argumentNames) {
    return function() {
      ...
      if (!asArray && !asHash && argumentNames) {
        console.warn(
          "Deprecation: RSVP.denodeify() doesn't allow setting the " +
