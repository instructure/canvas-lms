  ...
  })(
    {
      ...
      9: [
        function(_dereq_, module, exports) {
          ...
          var useFallbackData =
            !useCompositionEvent ||
            ('documentMode' in document && document.documentMode > 8 && document.documentMode <= 11)
          ...
          var DOMPropertyOperations = {
            ...
            createMarkupForProperty: function(name, value) {
              if (
                ...
                return (
                  processAttributeNameAndPrefix(attributeName) + escapeTextForBrowser(value) + '"'
                )
          ...
          var ReactCSSTransitionGroup = React.createClass({
            ...
            render: function() {
              return this.transferPropsTo(
                ReactTransitionGroup({childFactory: this._wrapChild}, this.props.children)
              )
            }
          })
          ...
          var ReactComponent = {
            ...
            Mixin: {
              ...
              updateComponent: function(transaction, prevDescriptor) {
                ...
                if (
                  nextDescriptor._owner !== prevDescriptor._owner ||
                  nextDescriptor.props.ref !== prevDescriptor.props.ref
                ) {
                  if (prevDescriptor.props.ref != null) {
                    ReactOwner.removeComponentAsRefFrom(
                      this,
                      prevDescriptor.props.ref,
                      prevDescriptor._owner
                    )
                  }
      ...
      38: [
        function(_dereq_, module, exports) {
          ...
          function mixSpecIntoComponent(Constructor, spec) {
            ...
            for (var name in spec) {
              ...
              if (RESERVED_SPEC_KEYS.hasOwnProperty(name)) {
                ...
                var isCompositeComponentMethod = ReactCompositeComponentInterface.hasOwnProperty(
                  name
                )
          ...
          var ReactCompositeComponentMixin = {
             ...
             * @internal
             */
            mountComponent: ReactPerf.measure('ReactCompositeComponent', 'mountComponent', function(
              rootID,
              transaction,
              mountDepth
            ) {
            ...
            _bindAutoBindMethods: function() {
              for (var autoBindKey in this.__reactAutoBindMap) {
                ...
                this[autoBindKey] = this._bindAutoBindMethod(
                  ReactErrorUtils.guard(method, this.constructor.displayName + '.' + autoBindKey)
                )
              }
            },
        ...
        },
        {
          ...
          './ReactCurrentOwner': 40,
          './ReactDescriptor': 56,
          './ReactDescriptorValidator': 57,
          './ReactEmptyComponent': 58,
          './ReactErrorUtils': 59,
          './ReactOwner': 70,
          './ReactPerf': 71,
          './ReactPropTransferer': 72,
          './ReactPropTypeLocationNames': 73,
          './ReactPropTypeLocations': 74,
          './ReactUpdates': 87,
          './instantiateReactComponent': 133,
          './invariant': 134,
          './keyMirror': 140,
      ...
      43: [
        function(_dereq_, module, exports) {
          ...
          function putListener(id, registrationName, listener, transaction) {
            ...
            if (container) {
              var doc =
                container.nodeType === ELEMENT_NODE_TYPE ? container.ownerDocument : container
          ...
          ReactDOMComponent.Mixin = {
             ...
             */
            mountComponent: ReactPerf.measure('ReactDOMComponent', 'mountComponent', function(
              rootID,
              transaction,
              mountDepth
            ) {
             ...
             * @overridable
             */
            updateComponent: ReactPerf.measure('ReactDOMComponent', 'updateComponent', function(
              transaction,
              prevDescriptor
            ) {
      ...
      53: [
        ...
        },
        {
          ...
          './ReactDOMSelect': 49,
          './ReactDOMTextarea': 51,
          './ReactDefaultBatchingStrategy': 52,
          './ReactDefaultPerf': 54,
      ...
      61: [
        function(_dereq_, module, exports) {
          ...
          function handleTopLevelImpl(bookKeeping) {
            var topLevelTarget =
              ReactMount.getFirstReactDOM(getEventTarget(bookKeeping.nativeEvent)) || window
        ...
        function(_dereq_, module, exports) {
          ...
          var ReactTestUtils = {
            ...
            isDescriptorOfType: function(inst, convenienceConstructor) {
              return (
                ReactDescriptor.isValidDescriptor(inst) && inst.type === convenienceConstructor.type
              )
            },
            ...
            isDOMComponentDescriptor: function(inst) {
              return !!(inst && ReactDescriptor.isValidDescriptor(inst) && !!inst.tagName)
            },
            ...
            isCompositeComponentDescriptor: function(inst) {
              ...
              return (
                typeof prototype.render === 'function' && typeof prototype.setState === 'function'
              )
            },

            isCompositeComponentDescriptorWithType: function(inst, type) {
              return !!(
                ReactTestUtils.isCompositeComponentDescriptor(inst) && inst.constructor === type
              )
            },
      ...
      86: [
        ...
        {
          './React': 29,
          './ReactTransitionChildMapping': 84,
          './cloneWithProps': 108,
          './emptyFunction': 116,
          './merge': 144
        }
      ...
      88: [
        ...
        },
        {
          './LinkedStateMixin': 24,
          './React': 29,
          './ReactCSSTransitionGroup': 32,
          './ReactComponentWithPureRenderMixin': 37,
          './ReactDefaultPerf': 54,
          './ReactTestUtils': 82,
          './ReactTransitionGroup': 86,
          './cloneWithProps': 108,
          './cx': 114,
          './update': 157
        }
          ...
          var traverseAllChildrenImpl = function(
            ...
            if (Array.isArray(children)) {
              for (var i = 0; i < children.length; i++) {
                ...
                var nextName =
                  nameSoFar + (nameSoFar ? SUBSEPARATOR : SEPARATOR) + getComponentKey(child, i)
