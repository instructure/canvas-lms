  ...
  function ha(b) {
        ...
        (g
          ? (k =
              B && B.normalize
                ...
                : c(a, d, e))
          : ((k = c(a, d, e)), (a = $(k)), (g = a[0]), (k = a[1]), (b = !0), (m = i.nameToUrl(k))))
    ...
    X.prototype = {
      ...
      defineDep: function(a, b) {
        this.depMatched[a] ||
          ((this.depMatched[a] = !0), (this.depCount -= 1), (this.depExports[a] = b))
      },
      fetch: function() {
        if (!this.fetched) {
          this.fetched = !0
              ...
              if (!this.defining) {
                ...
                if (1 > this.depCount && !this.defined) {
                  if (H(m)) {
                    ...
                    this.map.isDefine &&
                      ((b = this.module) && void 0 !== b.exports && b.exports !== this.exports
                        ? (e = b.exports)
                        : void 0 === e && this.usingExports && (e = this.exports))
                    if (a)
                      return (
              ...
              (m = u(this, function(a) {
                ...
                (m.fromText = u(this, function(e, c) {
                  ...
                  try {
                    ...
                    return v(
                      A('fromtexteval', 'fromText eval for ' + b + ' failed: ' + ca, ca, [b])
                    )
                  }
                  B && (O = !0)
                  this.depMaps.push(g)
    ...
    i = {
      ...
      configure: function(a) {
        ...
        F(a, function(a, b) {
          e[b]
            ? 'map' === b ? (k.map || (k.map = {}), Q(k[b], a, !0, !0)) : Q(k[b], a, !0)
            : (k[b] = a)
        })
        a.shim &&
      ...
      makeRequire: function(a, f) {
        function d(e, c, h) {
          ...
          if ('string' === typeof e) {
            if (H(c)) return v(A('requireargs', 'Invalid require call'), h)
