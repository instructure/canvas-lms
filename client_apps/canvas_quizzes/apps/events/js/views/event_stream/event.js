...
define(function(require) {
  ...
  var Event = React.createClass({
    ...
    renderRow: function(e) {
      var secondsSinceStart = (new Date(e.createdAt) - new Date(e.startedAt)) / 1000
        ...
        case K.EVT_QUESTION_VIEWED:
          ...
          description = (
            <div>
              ...
              <div className="ic-QuestionAnchors">{event.data.map(this.renderQuestionAnchor)}</div>
            </div>
          )
          break

        case K.EVT_PAGE_BLURRED:
          description = I18n.t('page_blurred', 'Stopped viewing the Canvas quiz-taking page...')
          break
