    ...
    render: function() {
      ...
      return (
        <Alert autoFocus type="danger" onClick={this.retryOrCancel}>
          <Text phrase="notifications.report_generation_failed" reportType={readableReportType}>
            It looks like something went wrong while generating the {'%{report_type}'} report. You
            may want to{' '}
            <a href="#" data-action="retry">
              retry
            </a>{' '}
            the operation, or{' '}
