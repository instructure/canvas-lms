...
module OtherHelperMethods
  ...
  TEST_FILE_UUIDS = {
      ...
      "attachments.zip" => Rails.root.join('spec/fixtures/attachments.zip'),
      "graded.png" => Rails.root.join('public/images/graded.png'),
      "cc_full_test.zip" => Rails.root.join('spec/fixtures/migration/cc_full_test.zip'),
      "cc_ark_test.zip" => Rails.root.join('spec/fixtures/migration/cc_ark_test.zip'),
      "canvas_cc_minimum.zip" => Rails.root.join('spec/fixtures/migration/canvas_cc_minimum.zip'),
      "canvas_cc_only_questions.zip" => Rails.root.join('spec/fixtures/migration/canvas_cc_only_questions.zip'),
      "qti.zip" => Rails.root.join('spec/fixtures/migration/package_identifier/qti.zip'),
      "a_file.txt" => Rails.root.join('spec/fixtures/files/a_file.txt'),
      "b_file.txt" => Rails.root.join('spec/fixtures/files/b_file.txt'),
      "c_file.txt" => Rails.root.join('spec/fixtures/files/c_file.txt'),
      "amazing_file.txt" => Rails.root.join('spec/fixtures/files/amazing_file.txt'),
      "Dog_file.txt" => Rails.root.join('spec/fixtures/files/Dog_file.txt'),
      "cn-image.jpg" => Rails.root.join('spec/fixtures/files/cn_image.jpg'),
      "empty_file.txt" => Rails.root.join('spec/fixtures/files/empty_file.txt'),
  }.freeze
