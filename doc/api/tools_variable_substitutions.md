...
Returns the Canvas id of the differentiation tag the current user is in if launching
from an assignment.
...
Returns the name of the differentiation tag the current user is in if launching
from an assignment.
