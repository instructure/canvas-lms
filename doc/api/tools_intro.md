...
| **Can register to be notified when Document Processor Assignment is submitted to** | Allows use of the 1EdTech Platform Notification Service.                                      | https://purl.imsglobal.org/spec/lti/scope/noticehandlers                  |
