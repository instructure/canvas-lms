        ...
        try {
          d =
            d === 'true'
              ...
              : d === 'false'
                ? !1
                : d === 'null' ? null : +d + '' === d ? +d : H.test(d) ? p.parseJSON(d) : d
        } catch (f) {}
        p.data(a, c, d)
      } else d = b
    }
      ...
      function bf(a, c, d, e, f) {
        ...
        for (; p < q; p++) {
          ...
          k
            ? ((j = j.concat(k)),
              (m = a.slice(i)) && m !== ')'
                ? B.test(m) ? bd(m, j, d, e) : Z(m, c, d, e ? e.concat(k) : k)
                : o.apply(d, j))
            : Z(a, c, d, e)
        }
          ...
          $.attrHandle[b]
            ...
            : U || d
              ...
              : ((c = a.getAttributeNode(b)),
                c
                  ? typeof a[b] == 'boolean' ? (a[b] ? b : null) : c.specified ? c.value : null
                  : null)
        )
      }),
        (Z.error = function(a) {
  ...
  p.fn.extend({
    ...
    is: function(a) {
      return (
        !!a &&
        (typeof a == 'string'
          ? bf.test(a) ? p(a, this.context).index(this[0]) >= 0 : p.filter(a, this).length > 0
    ...
    index: function(a) {
      return a
        ? typeof a == 'string' ? p.inArray(this[0], p(a)) : p.inArray(a.jquery ? a[0] : a, this)
  ...
  ;(bz.optgroup = bz.option),
    ...
    p.fn.extend({
      ...
      replaceWith: function(a) {
        return bh(this[0])
          ? this.length ? this.pushStack(p(p.isFunction(a) ? a() : a), 'replaceWith', a) : this
          : p.isFunction(a)
            ? this.each(function(b) {
                var c = p(this),
                  d = c.html()
