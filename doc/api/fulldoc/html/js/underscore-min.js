...
;(function() {
  ...
  'undefined' !== typeof exports
    ? ('undefined' !== typeof module && module.exports && (exports = module.exports = b),
      (exports._ = b))
    : (s._ = b)
  b.VERSION = '1.3.3'
  ...
  b.toArray = function(a) {
    return !a
      ...
      : b.isArray(a) || b.isArguments(a)
        ? i.call(a)
        : a.toArray && b.isFunction(a.toArray) ? a.toArray() : b.values(a)
  }
  b.size = function(a) {
  ...
  b.zip = function() {
    for (
      var a = i.call(arguments), c = b.max(b.pluck(a, 'length')), d = Array(c), e = 0;
      e < c;
      e++
    )
      d[e] = b.pluck(a, '' + e)
  ...
  b.range = function(a, b, d) {
    ...
    for (
      var d = arguments[2] || 1, e = Math.max(Math.ceil((b - a) / d), 0), f = 0, g = Array(e);
      f < e;
