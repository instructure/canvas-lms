...
var Docs = {
  ...
  expandOperationsForResource: function(resource) {
    ...
    $('li#resource_' + Docs.escapeResourceName(resource) + ' li.operation div.content').each(
      function() {
  ...
  templates['main'] = template(function(Handlebars, depth0, helpers, partials, data) {
    ...
    function program1(depth0, data) {
      ...
      buffer +=
        ...
        escapeExpression(
          ((stack1 = ((stack1 = depth0.info),
          stack1 == null || stack1 === false ? stack1 : stack1.title)),
          typeof stack1 === functionType ? stack1.apply(depth0) : stack1)
        ) +
        '</div>\n    <div class="info_description">'
      stack2 = ((stack1 = ((stack1 = depth0.info),
      stack1 == null || stack1 === false ? stack1 : stack1.description)),
      typeof stack1 === functionType ? stack1.apply(depth0) : stack1)
      if (stack2 || stack2 === 0) {
        buffer += stack2
      }
      buffer += '</div>\n    '
      stack2 = helpers['if'].call(
        depth0,
        ((stack1 = depth0.info),
        stack1 == null || stack1 === false ? stack1 : stack1.termsOfServiceUrl),
      ...
      stack2 = helpers['if'].call(
        depth0,
        ((stack1 = depth0.info), stack1 == null || stack1 === false ? stack1 : stack1.contact),
      ...
      stack2 = helpers['if'].call(
        depth0,
        ((stack1 = depth0.info), stack1 == null || stack1 === false ? stack1 : stack1.license),
        {hash: {}, inverse: self.noop, fn: self.program(6, program6, data), data: data}
      )
      if (stack2 || stack2 === 0) {
        buffer += stack2
      }
    ...
    function program4(depth0, data) {
      ...
      buffer +=
        ...
        escapeExpression(
          ((stack1 = ((stack1 = depth0.info),
          stack1 == null || stack1 === false ? stack1 : stack1.contact)),
          typeof stack1 === functionType ? stack1.apply(depth0) : stack1)
        ) +
    ...
    function program6(depth0, data) {
      ...
      buffer +=
        ...
        escapeExpression(
          ((stack1 = ((stack1 = depth0.info),
          stack1 == null || stack1 === false ? stack1 : stack1.licenseUrl)),
          typeof stack1 === functionType ? stack1.apply(depth0) : stack1)
        ) +
        "'>" +
        escapeExpression(
          ((stack1 = ((stack1 = depth0.info),
          stack1 == null || stack1 === false ? stack1 : stack1.license)),
          typeof stack1 === functionType ? stack1.apply(depth0) : stack1)
        ) +
        '</a></div>'
      return buffer
...
;(function() {
  ...
  templates['param_list'] = template(function(Handlebars, depth0, helpers, partials, data) {
    ...
    buffer += '\n    '
    stack2 = helpers.each.call(
      depth0,
      ((stack1 = depth0.allowableValues),
      stack1 == null || stack1 === false ? stack1 : stack1.descriptiveValues),
      {hash: {}, inverse: self.noop, fn: self.program(13, program13, data), data: data}
    )
    if (stack2 || stack2 === 0) {
      buffer += stack2
    }
...
;(function() {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {})
  templates['param_readonly_required'] = template(function(
    Handlebars,
    depth0,
    helpers,
    partials,
...
;(function() {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {})
  templates['parameter_content_type'] = template(function(
    Handlebars,
    depth0,
    helpers,
    partials,
...
;(function() {
  var template = Handlebars.template,
    templates = (Handlebars.templates = Handlebars.templates || {})
  templates['response_content_type'] = template(function(
    Handlebars,
    depth0,
    helpers,
    partials,
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      var contentTypeModel,
        ...
        _ref6,
        _ref7
      if (!window.authorizations.authz.key) isMethodSubmissionSupported = false
      else isMethodSubmissionSupported = true
    ...
    OperationView.prototype.handleFileUpload = function(map, form) {
      ...
      this.invocationUrl = this.model.supportHeaderParams()
        ? ((headerParams = this.model.getHeaderParams(map)), this.model.urlify(map, false))
        : this.model.urlify(map, true)
    ...
    OperationView.prototype.wrap = function(data) {
      ...
      for (
        i = _i = 0, _ref5 = headerArray.length / 2, _ref6 = 2;
        _ref6 > 0 ? _i <= _ref5 : _i >= _ref5;
        i = _i += _ref6
      ) {
    ...
    OperationView.prototype.showStatus = function(response) {
      ...
      contentType =
        headers && headers['Content-Type'] ? headers['Content-Type'].split(';')[0].trim() : null
      if (!content) {
      ...
      $('.response_headers', $(this.el)).html(
        '<pre>' + JSON.stringify(response.headers, null, '  ').replace(/\n/g, '<br>') + '</pre>'
      )
    ...
    OperationView.prototype.toggleOperationContent = function() {
      ...
      elem = $(
        '#' +
          Docs.escapeResourceName(this.model.resourceName) +
          '_' +
          this.model.nickname +
          '_' +
          this.model.method +
