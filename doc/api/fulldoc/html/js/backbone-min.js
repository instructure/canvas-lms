...
;(function() {
    ...
    k = (g.Events = {
      ...
      trigger: function(a) {
        ...
        for (g = z.call(arguments, 1); (b = a.shift()); ) {
          if ((c = d[b]))
            for (e = c.tail; (c = c.next) !== e; ) c.callback.apply(c.context || this, g)
          if ((c = f)) {
            e = c.tail
  ...
  f.extend(o.prototype, k, {
    ...
    set: function(a, b, c) {
      ...
      for (e in d) {
        ...
        if (!f.isEqual(h[e], a) || (c.unset && f.has(h, e)))
          delete g[e], ((c.silent ? this._silent : b)[e] = !0)
    ...
    url: function() {
      ...
      return this.isNew()
        ? a
        : a + ('/' == a.charAt(a.length - 1) ? '' : '/') + encodeURIComponent(this.id)
    },
    parse: function(a) {
      return a
    },
    ...
    _onModelEvent: function(a, b, c, d) {
      ;(('add' == a || 'remove' == a) && c != this) ||
        ...
        b &&
          ...
          (delete this._byId[b.previous(b.idAttribute)], (this._byId[b.id] = b)),
  ...
  f.extend(m.prototype, k, {
    ...
    start: function(a) {
      ...
      if ((b = E.exec(navigator.userAgent.toLowerCase()) && (!b || 7 >= b)))
        (this.iframe = i('<iframe src="javascript:0" tabindex="-1" />')
          .hide()
          .appendTo('body')[0].contentWindow),
          this.navigate(a)
      this._hasPushState
        ? i(window).bind('popstate', this.checkUrl)
      ...
      this._wantsPushState &&
        ...
        window.history.replaceState(
          {},
          document.title,
          a.protocol + '//' + a.host + this.options.root + this.fragment
        ))
    ...
    navigate: function(a, b) {
      ...
      this.fragment != c &&
        (this._hasPushState
          ? (0 != c.indexOf(this.options.root) && (c = this.options.root + c),
            (this.fragment = c),
            window.history[b.replace ? 'replaceState' : 'pushState']({}, document.title, c))
          : this._wantsHashChange
            ? ((this.fragment = c),
              ...
              this.iframe &&
                ...
                this._updateHash(this.iframe.location, c, b.replace)))
            : window.location.assign(this.options.root + a),
