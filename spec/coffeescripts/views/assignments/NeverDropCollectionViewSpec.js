...
// EVAL-3815
QUnit.skip('NeverDropCollectionView', {
  setup() {
...
QUnit.skip('possibleValues is set to the range of assignment ids', function () {
  deepEqual(
...
QUnit.skip('adding a NeverDrop to the collection reduces availableValues by one', function () {
...
QUnit.skip('needs rewrite due to debounce hack', () => {
