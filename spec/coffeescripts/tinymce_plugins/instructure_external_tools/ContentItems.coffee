...
define [], ->
  ...
  return {
    "lti_thumb_window": {
      ...
      "canvasURL": "/courses/1/external_tools/retrieve?url=http%3A%2F%2Flti-tool-provider-example.dev%2Fmessages%2Fblti"
    },
    "lti_thumb_frame": {
    ...
    "lti_thumb_iframe": {
      ...
      "@type": "LtiLink",
      "@id": "http://lti-tool-provider-example.dev/messages/blti",
      "canvasURL": "/courses/1/external_tools/retrieve?display=borderless&url=http%3A%2F%2Flti-tool-provider-example.dev%2Fmessages%2Fblti"
    },
    "lti_thumb_embed": {
