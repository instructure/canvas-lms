...
test('no double encoding of url', () =>
  equal(
    formatMessage(
      'https://blah.blee.com/Steven%20Test/thing%20that%20cool\u2026anvas_non_Demonstration_-_Flash_%28joel%29_-_123456_03.41.18PM.html '
    ),
...
test('formatMessage: prepends http:// to a link to example.com/things', () =>
  equal(
    formatMessage('example.com/things'),
    "<a href='http:&#x2F;&#x2F;example.com&#x2F;things'>example.com&#x2F;things</a>"
  ))
