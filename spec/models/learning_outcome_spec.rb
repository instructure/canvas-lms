    ...
    context "default values" do
      ...
      context "color and mastery defaults" do
        ...
        it "4 ratings" do
          ...
          expect(ratings.pluck(:color)).to eq %w[03893D FAB901 E0061F 555555]
        end
        ...
        it "5 ratings" do
          ...
          expect(ratings.pluck(:color)).to eq %w[0374B5 03893D FAB901 E0061F 555555]
        end
        ...
        it "6 ratings" do
          ...
          expect(ratings.pluck(:color)).to eq %w[0374B5 03893D FAB901 D97900 E0061F 555555]
        end
