...
describe Messages::SubmissionCommentForTeacher::SummaryPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::SubmissionCommentForTeacher::SummaryPresenter.new(message) }
  ...
  describe "generated message" do
    let(:message) { generate_message("Submission Comment For Teacher", :summary, submission_comment, {}) }
