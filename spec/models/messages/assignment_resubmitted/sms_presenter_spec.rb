...
describe Messages::AssignmentResubmitted::SMSPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentResubmitted::SMSPresenter.new(message) }
  ...
  describe "generated message" do
    let(:message) { generate_message(:assignment_resubmitted, :sms, submission, {}) }
