...
describe Messages::AssignmentResubmitted::SummaryPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentResubmitted::SummaryPresenter.new(message) }
  ...
  describe "generated message" do
    let(:message) { generate_message(:assignment_resubmitted, :summary, submission, {}) }
    let(:presenter) do
      msg = Message.new(context: submission, user: teacher)
      Messages::AssignmentResubmitted::SummaryPresenter.new(msg)
    end
