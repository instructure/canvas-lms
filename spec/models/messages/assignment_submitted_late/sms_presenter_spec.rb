...
describe Messages::AssignmentSubmittedLate::SMSPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentSubmittedLate::SMSPresenter.new(message) }
  ...
  describe "generated message" do
    let(:message) { generate_message(:assignment_submitted_late, :sms, submission, {}) }
