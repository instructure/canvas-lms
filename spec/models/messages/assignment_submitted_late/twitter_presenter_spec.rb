...
describe Messages::AssignmentSubmittedLate::TwitterPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentSubmittedLate::TwitterPresenter.new(message) }
  ...
  describe "generated message" do
    let(:message) { generate_message(:assignment_submitted_late, :twitter, submission, {}) }
    let(:presenter) do
      msg = Message.new(context: submission, user: teacher)
      Messages::AssignmentSubmittedLate::TwitterPresenter.new(msg)
    end
