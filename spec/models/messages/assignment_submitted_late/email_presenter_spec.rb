...
describe Messages::AssignmentSubmittedLate::EmailPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentSubmittedLate::EmailPresenter.new(message) }
  ...
  describe "HTML message" do
    ...
    let(:presenter) do
      ...
      Messages::AssignmentSubmittedLate::EmailPresenter.new(msg)
    end
