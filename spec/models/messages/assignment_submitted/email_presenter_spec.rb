...
describe Messages::AssignmentSubmitted::EmailPresenter do
  ...
  describe "Presenter instance" do
    ...
    let(:presenter) { Messages::AssignmentSubmitted::EmailPresenter.new(message) }
  ...
  describe "HTML message" do
    let(:message) { generate_message(:assignment_submitted, :email, submission, {}) }
    let(:presenter) do
      msg = Message.new(context: submission, user: teacher)
      Messages::AssignmentSubmitted::EmailPresenter.new(msg)
    end
