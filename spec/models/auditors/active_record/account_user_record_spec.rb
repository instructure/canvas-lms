...
describe Auditors::ActiveRecord::AccountUserRecord do
  describe ".ar_attributes_from_event_stream" do
    ...
    it "uses a local id as the account_user_id" do
