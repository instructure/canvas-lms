...
describe Quizzes::QuizStatistics::ItemAnalysis do
  ...
  it "generates a csv" do
    ...
    expect(stats[2]).to eq [qs[1].id.to_s, "Question text", "6", "2", "2", "2", "4", "4", "2", "0.6666666666666666", "0.3333333333333333", "2", "1", "1", "0.22222222222222224", "0.4714045207910317", "0.6666666666666666", "0.7786666666666666", "0.6324555320336759", "-0.7", "-0.09999999999999999", nil]
    expect(stats[3]).to eq [qs[2].id.to_s, "Question text", "5", "2", "2", "1", "4", "3", "2", "0.6", "0.4", "2", "1", "0", "0.24000000000000005", "0.48989794855663565", "0.6", "0.7786666666666666", "0.8728715609439694", "-0.8728715609439694", nil, nil]
  ...
  it "generates" do
    ...
    expect(item[:alpha]).to be_within(precision).of(0.7786666666666666)
