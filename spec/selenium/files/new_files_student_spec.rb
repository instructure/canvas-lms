...
describe "better_file_browsing" do
  ...
  context "as a student" do
    ...
    context "in course with files" do
      ...
      it "only sees Download option on cog icon", priority: "1", upgrade_files_v2: "done" do
      ...
      it "only sees View and Download options on toolbar menu", priority: "1", upgrade_files_v2: "done" do
        get "/courses/#{@course.id}/files"
        content = f("#content")
        f(".ef-item-row").click
      ...
      it "sees calendar icon on restricted files within a given timeframe", priority: "1", upgrade_files_v2: "done" do
