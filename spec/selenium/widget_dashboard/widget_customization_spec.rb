...
describe "student dashboard widget customization tests", :ignore_js_errors do
  ...
  it "enters and exits edit mode with save and cancel buttons" do
    ...
    expect(widget_drag_handle("course-work-combined-widget")).to be_displayed
  ...
  context "Rearrange widget via context menu" do
    it "moves widgets up and down using context menu options" do
      ...
      expect(widget_drag_handle("people-widget")).to be_displayed
      widget_drag_handle("people-widget").click
    ...
    it "moves widget to top and bottom using context menu option" do
      ...
      expect(widget_drag_handle("course-work-combined-widget")).to be_displayed
      widget_drag_handle("course-work-combined-widget").click
    ...
    it "moves widgets between columns using context menu options" do
      ...
      expect(widget_drag_handle("announcements-widget")).to be_displayed
      widget_drag_handle("announcements-widget").click
      ...
      widget_drag_handle("course-grades-widget").click
