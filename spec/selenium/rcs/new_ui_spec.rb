...
describe 'new ui' do
  ...
  context 'as teacher' do
    ...
    it 'breadcrumbs show for course navigation menu item', priority: "2", test_id: 242471 do
      ...
      expect(f('.home + li .ellipsible')).to include_text @course.course_code.to_s
    end
    ...
    it 'breadcrumbs show for course discussions navigation menu item', priority: "2", test_id: 856929, ignore_js_errors: true do
    ...
    it 'breadcrumbs show for course files navigation menu item', priority: "2", test_id: 856933 do
      ...
      expect(f('.ellipsible')).to include_text @course.course_code.to_s
    end
    ...
    context 'as student' do
      ...
      it 'should still have courses icon when only course is unpublished', priority: "1", test_id: 288860 do
        ...
        global_nav_courses_link = f('#global_nav_courses_link')
        ...
        wait_for_ajaximations
        expect(f('#my_courses_table .course-list-table-row .name')).to include_text(@course.name)
        expect(f('#my_courses_table .course-list-table-row')).to include_text('This course has not been published.')
      end
    end
  end
end
