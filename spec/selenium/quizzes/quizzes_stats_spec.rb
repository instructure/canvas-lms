...
describe "quizzes stats" do
  ...
  context "as a teacher" do
    ...
    it "displays quiz statistics", priority: "1" do
    ...
    it "has a link to the new quiz stats page", priority: "2" do
      quiz_with_submission
      get "/courses/#{@course.id}/quizzes/#{@quiz.id}"
    ...
    context "teacher preview" do
      it "does not show a quiz stats button if there was a teacher preview", priority: "2" do
