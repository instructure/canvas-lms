...
describe "announcements" do
  ...
  context "announcements as a teacher" do
    ...
    describe "shared bulk topics specs" do
      ...
      it "should bulk lock topics", priority: "1", test_id: 220361 do # no
        5.times { |i| @checkboxes[i].click }
      ...
      it "should search by title", priority: "1", test_id: 150525 do # no
        expected_text = 'hey there'
        update_attributes_and_validate(:title, expected_text)
      end

      it "should search by body", priority: "1", test_id: 220358 do # no
        body_text = 'new topic body'
        update_attributes_and_validate(:message, body_text, 'topic')
      end

      it "should search by author", priority: "1", test_id: 220359 do # no
      ...
      it "should search an entire phrase" do # no
        replace_content(f('#searchTerm'), 'new 001')
        expect(ff('.discussionTopicIndexList .discussion-topic').count).to eq 1
      end

      it "should return multiple items in the search", priority: "1", test_id: 220362 do # no
        new_title = 'updated'
      ...
      it "should filter by unread", priority: "1", test_id: 220363 do # no
    ...
    describe "shared main page topics specs" do
      ...
      it "should have a lock that appears and disappears when the cog menu is used to lock/unlock the announcement for comments", priority: "1", test_id: 220365 do # no
    ...
    it "should add and remove an external feed to announcements", priority: "1", test_id: 220370 do # no
