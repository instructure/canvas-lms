    ...
    describe Api::V1::CourseJson do
      ...
      describe '#include_total_scores' do
        ...
        describe '#methods_to_send' do
          it 'usually just has the end_at field' do
            course_json.methods_to_send.should == ['end_at']
          end

          it 'adds the hide_final_grades method if its in the includes array' do
            includes << :hide_final_grades
            course_json.methods_to_send.should == ['end_at', 'hide_final_grades']
          end
        end
