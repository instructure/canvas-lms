...
describe MethodView do
  ...
  let(:response_field_tag) do
    instance_double(YARD::Tags::Tag, tag_name: "response_field", text: "bar A description.")
  end

  let(:deprecated_response_field_tag) do
    instance_double(YARD::Tags::Tag, tag_name: "deprecated_response_field", text: "baz NOTICE 2018-01-05 EFFECTIVE 2018-05-05\nA description.")
  end

  let(:deprecated_method_tag) do
    text = "NOTICE 2018-01-05 EFFECTIVE 2018-05-05\nA description."
    instance_double(YARD::Tags::Tag, tag_name: "deprecated_method", text:)
  end

  describe "#deprecated?" do
    it "returns true when there is a deprecated method tag" do
      view = MethodView.new(instance_double(YARD::CodeObjects::MethodObject, tags: [argument_tag, deprecated_method_tag]))
      expect(view).to be_deprecated
    end

    it "returns false when there is not a deprecated method tag" do
      view = MethodView.new(instance_double(YARD::CodeObjects::MethodObject, tags: [argument_tag]))
  ...
  describe "#raw_arguments" do
    it "excludes tags that are not arguments" do
      view = MethodView.new(instance_double(YARD::CodeObjects::MethodObject, tags: [response_field_tag]))
    ...
    it "includes deprecated argument tags" do
      view = MethodView.new(instance_double(YARD::CodeObjects::MethodObject, tags: [deprecated_argument_tag]))
  ...
  describe "#raw_response_fields" do
    ...
    it "includes deprecated response_field tags" do
      view = MethodView.new(instance_double(YARD::CodeObjects::MethodObject, tags: [deprecated_response_field_tag]))
