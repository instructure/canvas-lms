...
define(
  ['underscore', 'jsx/add_people/actions', 'jsx/add_people/reducer'],
  (_, {actions}, reducer) => {
    // dummy test data ---------------
    ...
    test('VALIDATE_USERS_SUCCESS', () => {
      ...
      deepEqual(
        newState.userValidationResult.duplicates,
        dupeList,
        'userValidationResult.duplicates'
      )
    ...
    test('CHOOSE_DUPLICATE', () => {
      ...
      equal(
        newState.userValidationResult.duplicates.bob.createNew,
        false,
        'duplicate set createNew'
      )
      equal(
    ...
    test('ENQUEUE_NEW_FOR_MISSING', () => {
      ...
      deepEqual(
        newState.userValidationResult.duplicates,
        dupeList,
        'userValidationResult.dupliates'
      )
      deepEqual(
        newState.userValidationResult.validUsers,
        goodUsers,
    ...
    test('CREATE_USERS_SUCCESS', () => {
      ...
      deepEqual(
        newState.apiState,
        {pendingCount: 0, error: undefined},
        'api is no longer in-flight'
      )
      deepEqual(
        newState.userValidationResult,
        runningState.userValidationResult,
