...
define(
  ['react', 'react-dom', 'react-addons-test-utils', 'jsx/add_people/components/people_search'],
  (React, ReactDOM, TestUtils, PeopleSearch) => {
    ...
    test('sets the correct values', () => {
      ...
      const limitPrivilegeCheckbox = peopleSearch.querySelector(
    ...
    test('shows hint with bad email address', () => {
      ...
      ok(
        peopleSearch.innerHTML.includes(
          'It looks like you have an invalid email address: "foobar@"'
        )
      )
    })
  }
