...
QUnit.module('SubmissionTray', function(hooks) {
  ...
  test('shows SpeedGrader link if enabled', function() {
    const speedGraderUrl =
      '/courses/1/gradebook/speed_grader?assignment_id=30#%7B%22student_id%22%3A27%7D'
    mountComponent()
  ...
  test('passes along assignment prop to SubmissionStatus', function() {
    mountComponent()
    const submissionStatusProps = wrapContent()
      .find('SubmissionStatus')
      .at(0)
      .props()
  ...
  test('passes along isInOtherGradingPeriod prop to SubmissionStatus', function() {
    mountComponent()
    const isInOtherGradingPeriod = wrapContent()
      .find('SubmissionStatus')
      .at(0)
      .prop('isInOtherGradingPeriod')
  ...
  test('passes along isInClosedGradingPeriod prop to SubmissionStatus', function() {
    mountComponent()
    const isInClosedGradingPeriod = wrapContent()
      .find('SubmissionStatus')
      .at(0)
      .prop('isInClosedGradingPeriod')
  ...
  test('passes along isInNoGradingPeriod prop to SubmissionStatus', function() {
    mountComponent()
    const isInNoGradingPeriod = wrapContent()
      .find('SubmissionStatus')
      .at(0)
      .prop('isInNoGradingPeriod')
  ...
  QUnit.module('LatePolicyGrade', function() {
    ...
    test('uses the submission to show the late policy grade', function() {
      mountComponent()
      const latePolicyGrade = wrapContent()
        .find('LatePolicyGrade')
        .at(0)
  ...
  test('enables the late policy radio input group when gradingDisabled is false', function() {
    ...
    strictEqual(
      wrapContent()
        .find('SubmissionTrayRadioInputGroup')
        .props().disabled,
      false
    )
  })
  ...
  test('shows assignment carousel with no left arrow when isFirstAssignment and isLastAssignment are true', function() {
    mountComponent()
    strictEqual(
      wrapContent().find('#assignment-carousel .left-arrow-button-container button').length,
      0
    )
  })
  ...
  test('shows assignment carousel with no right arrow when isFirstAssignment and isLastAssignment are true', function() {
    mountComponent()
    strictEqual(
      wrapContent().find('#assignment-carousel .right-arrow-button-container button').length,
      0
    )
  })
  ...
  test('shows student carousel with no left arrow when isFirstStudent and isLastStudent are true', function() {
    mountComponent()
    strictEqual(
      wrapContent().find('#student-carousel .left-arrow-button-container button').length,
      0
    )
  })
  ...
  test('shows student carousel with right arrow when isFirstStudent and isLastStudent are false', function() {
    ...
    strictEqual(
      wrapContent().find('#student-carousel .right-arrow-button-container button').length,
      1
    )
  })
