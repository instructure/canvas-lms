...
import {DEFAULT_LATE_POLICY_DATA} from 'jsx/gradezilla/default_gradebook/apis/GradebookSettingsModalApi'
...
QUnit.module(
  'Gradezilla > Default Gradebook > Components > LatePoliciesTabPanelPercentageNumberInput',
  withoutEnzymeHooks => {
    let $container
    let props
