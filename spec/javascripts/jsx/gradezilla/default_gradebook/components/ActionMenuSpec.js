...
test('returns the previous export stored in the state if it is available', function() {
  ...
  const lastExportFromState = this.stub(ActionMenu.prototype, 'lastExportFromState').returns(
    stateExport
  )
...
test('returns the previous export stored in the props if nothing is available in state', function() {
  ...
  const lastExportFromProps = this.stub(ActionMenu.prototype, 'lastExportFromProps').returns(
    previousExportProps().lastExport
  )
