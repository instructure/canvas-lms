...
define(
  ['react', 'react-addons-test-utils', 'jsx/collaborations/CollaborationsApp'],
  (React, TestUtils, CollaborationsApp) => {
    ...
    test('renders the getting started component when there are no collaborations', () => {
      ...
      let gettingStarted = TestUtils.findRenderedDOMComponentWithClass(
        component,
    ...
    test('renders the list of collaborations when there are some', () => {
      ...
      let collaborationsList = TestUtils.findRenderedDOMComponentWithClass(
        component,
        'CollaborationsList'
      )
