...
QUnit.module('GradebookGrid StudentLastNameCellFormatter', hooks => {
  let $fixture
  let gradebook
  let formatter
  let student
  ...
  QUnit.module('#render() with an active student', () => {
    ...
    test('renders the student last name', () => {
      equal(studentGradesLink().innerHTML, student.last_name)
    })

    test('escapes HTML in the student last name', () => {
      student.last_name = '<span>Jones</span>'
      equal(studentGradesLink().innerHTML, '&lt;span&gt;Jones&lt;/span&gt;')
    })
    ...
    test('handles blank student last name', () => {
      student.last_name = ''
      equal(studentGradesLink().innerHTML, '&lt;No last name&gt;')
    })
  })
