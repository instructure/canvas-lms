...
define(
  ...
  (_, $, ProcessGradebookUpload, fakeENV) => {
    ...
    test('alters a grade on an existing assignment', () => {
      ...
      equal(
        gradeData[submissionOld1Change.assignment_id][0].posted_grade,
    ...
    test('handles creation of a new assignment with a grade change', () => {
      ...
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse1.id][student.previous_id]
          .posted_grade,
        submissionNew1Change.grade
      )
    ...
    test('handles multiple students changing a single new assignment', () => {
      ...
      const bulkUpdateRequest = JSON.parse(requests[1].requestBody)
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse1.id][student1.previous_id]
          .posted_grade,
        submissionNew1Change.grade
      )
      equal(
    ...
    test('handles multiple students changing multiple new assignments', () => {
      ...
      const gradebook = {
        students: [student1, student2],
        assignments: [newAssignment1, newAssignment2]
      }
      ProcessGradebookUpload.upload(gradebook)
      ...
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse2.id][student2.previous_id]
          .posted_grade,
        submissionNew2Change.grade
      )
    ...
    test('handles multiple students changing multiple new and existing assignments', () => {
      ...
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse1.id][student2.previous_id]
          .posted_grade,
        submissionNew1Change.grade
      )
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse2.id][student1.previous_id]
          .posted_grade,
        submissionNew2Change.grade
      )
      equal(
      ...
      equal(
        bulkUpdateRequest.grade_data[createAssignmentResponse2.id][student3.previous_id]
          .posted_grade,
        submissionNew2Change.grade
      )
