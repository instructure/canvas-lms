...
define(
  ...
  (
    ...
    test('clicking the info button should render out the info panel', () => {
      ...
      const infoBtn = TestUtils.findRenderedDOMComponentWithClass(
        modalPortal,
        'ef-file-preview-header-info'
      )
    ...
    test('opening the preview for one file should show navigation buttons for the previous and next files in the current folder', () => {
      ...
      const modalPortal = component.refs.modal.portal
      const arrows = TestUtils.scryRenderedDOMComponentsWithClass(
        modalPortal,
    ...
    test('download button should be rendered on the file preview', () => {
      ...
      const modalPortal = component.refs.modal.portal
      const downloadBtn = TestUtils.findRenderedDOMComponentWithClass(
        modalPortal,
        'ef-file-preview-header-download'
      )
    ...
    test('clicking the close button calls closePreview with the correct url', () => {
      ...
      const modalPortal = component.refs.modal.portal
      const closeButton = TestUtils.findRenderedDOMComponentWithClass(
        modalPortal,
        'ef-file-preview-header-close'
      )
      ok(closeButton)
