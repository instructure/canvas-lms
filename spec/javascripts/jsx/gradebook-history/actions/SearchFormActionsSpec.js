...
QUnit.module('SearchFormActions getGradebookHistory', {
  setup() {
    ...
    this.getGradebookHistoryStub = this.stub(HistoryApi, 'getGradebookHistory').returns(
...
QUnit.module('SearchFormActions getSearchOptions', {
  setup() {
    ...
    this.getUsersByNameStub = this.stub(UserApi, 'getUsersByName').returns(
      Promise.resolve(this.userResponse)
    )
