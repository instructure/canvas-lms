...
test('renders the title as a Link when given an href prop', () => {
  const wrapper = mount(<ToDoItem {...getDefaultProps({href: '/some_example_url'})} />)
