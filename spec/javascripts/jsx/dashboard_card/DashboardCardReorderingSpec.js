...
define(
  ...
  (
    ...
    test('it renders', () => {
      ...
      const root = TestUtils.renderIntoDocument(<Box reorderingEnabled courseCards={cards} />)
      ok(root)
    })
    ...
    test('moving a card adjusts the position property', () => {
      ...
      const root = TestUtils.renderIntoDocument(
        <Box reorderingEnabled courseCards={cards} connectDropTarget={el => el} />
      )
      ...
      const sourceHandlerId = renderedCardComponents[0]
