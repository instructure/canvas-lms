 ...
 */
  ...
  QUnit.load = function () {
    ...
    if (toolbar) {
      ...
      addEvents(urlConfigCheckboxes, 'click', (event) => {
        let params = {},
      ...
      if (numModules > 1) {
        ...
        addEvent(moduleFilter.lastChild, 'change', () => {
          let selectBox = moduleFilter.getElementsByTagName('select')[0],
  ...
  window.onerror = function (error, filePath, linerNr) {
    ...
    if (ret !== true) {
      if (QUnit.config.current) {
        ...
        QUnit.test('global failure', extend(() => {
          QUnit.pushFailure(error, `${filePath}:${linerNr}`);
        }, { validTest }));
      }
      return false;
