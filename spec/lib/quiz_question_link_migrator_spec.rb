...
describe QuizQuestionLinkMigrator do
  context "for_each_interesting_field" do
    it "should yield for each interesting root-level field" do
      ...
      yielded = []
      QuizQuestionLinkMigrator.for_each_interesting_field(data) do |field|
        yielded << field
      end
  ...
  context "related_attachment_ids" do
    ...
    it "should include the input" do
      ids = QuizQuestionLinkMigrator.related_attachment_ids(@file.id)
  ...
  context "migrate_file_link" do
    ...
    it "should pass links unchanged when the question has no assessment_question" do
      ...
      new_link = QuizQuestionLinkMigrator.migrate_file_link(@question, link)
    ...
    it "should find links in the assessment question for related attachments" do
      ...
      new_link = QuizQuestionLinkMigrator.migrate_file_link(@question, source_link)
    ...
    it "reuse cached translations" do
      ...
      QuizQuestionLinkMigrator.migrate_file_link(@question, source_link)
  ...
  context"migrate_file_links_in_blob" do
    ...
    it "should migrate links for the wrong course" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_blob(source_blob, @question, @question.quiz)
    ...
    it "should return true iff a link was migrated" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_blob(source_blob, @question, @question.quiz).should be_true
      QuizQuestionLinkMigrator.migrate_file_links_in_blob(source_blob, @question, @question.quiz).should be_false
    end
  end
  ...
  context "migrate_file_links_in_question_data" do
    ...
    it "should migrate links in each interesting field" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_question_data(question_data, :question => @question)
    ...
    it "should infer the contextual question from the question_data" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_question_data(question_data)
      question_data[:question_text].should == @target_blob
    end
    ...
    it "should return true iff a link was migrated" do
      ...
      # first time true, second time false because it's already migrated
      QuizQuestionLinkMigrator.migrate_file_links_in_question_data(question_data, :question => @question).should be_true
      QuizQuestionLinkMigrator.migrate_file_links_in_question_data(question_data, :question => @question).should be_false
    end
  end
  ...
  context "migrate_file_links_in_question" do
    ...
    it "should return true iff a question was migrated" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_question(@question).should be_false
    end
  end
  ...
  context "migrate_file_links_in_quiz" do
    ...
    it "should migrate links each question in the quiz's data" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_quiz(@quiz)
    ...
    it "should not migrate links where the course matches the quiz's course but not the question's quiz's course" do
      ...
      QuizQuestionLinkMigrator.migrate_file_links_in_quiz(@quiz2)
    ...
    it "should return true iff a link was migrated" do
      ...
      # first time true, second time false because it's already migrated
      QuizQuestionLinkMigrator.migrate_file_links_in_quiz(@quiz).should be_true
      QuizQuestionLinkMigrator.migrate_file_links_in_quiz(@quiz).should be_false
    end
  end
end
