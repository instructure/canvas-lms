...
describe "submission_grade_changed" do
  ...
  context "discussion checkpoint submissions" do
    ...
    it "uses parent assignment ID in URLs for email notifications" do
      email = generate_message(:submission_grade_changed, :email, @checkpoint_submission, user: @student)
    ...
    it "uses parent assignment ID in URLs for summary notifications" do
      summary = generate_message(:submission_grade_changed, :summary, @checkpoint_submission, user: @student)
